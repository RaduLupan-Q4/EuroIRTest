...
function loadClickHandlers() {
    ...
    $('.goToHome').click(function () {
        ...
        $('.pageVerification').hide();
        $('.enterInformationEmail').val('');
        $('.enterInformationFirstName').val('');
        $('.enterInformationLastName').val('');
        $('.enterInformationCompany').val('');
        $('.enterInformationCountry').val('');
        $('.checkboxRelease.ReleasesA').removeAttr('checked');
        $('.checkboxRelease.ReleasesC').removeAttr('checked');
        $('.unsubscribeEmail').val('');
