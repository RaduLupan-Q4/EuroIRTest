...
<div class="tabs-container">
    ...
    <div id="container" class="tabs">
        <ul class="tabsWrapper">
            <li class="tabitem firstTab"><a href="#tab-1">Share Price</a></li>
            <li class="tabitem tab2"><a href="#tab-2">Stock Chart</a></li>
            <li class="tabitem lastTab"><a href="#tab-3">Historical Lookup</a></li>
        </ul>

        <div id="tab-1">

            <iframe id="summaryIframe" src="profile.aspx"></iframe>

        </div>
        <div id="tab-2">

            <iframe id="simpleLookupiFrame" src="chart.aspx"></iframe>

        </div>
        <div id="tab-3">

            <iframe id="miniquoteChartiFrame" src="lookup.aspx"></iframe>
