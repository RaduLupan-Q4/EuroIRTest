...
<% 
    // Settings
    string activeClient = "MotorpointPlc";
    int solutionID = 2472;
    int instrumentID = 30863000;
    int newsSourceID = 1012; //Needed for IPO!
...
<head>
    ...
    <link href='//fonts.googleapis.com/css?family=Ek+Mukta:400,500,700' rel='stylesheet' type='text/css'>
...
If you would like to unsubscribe, please login and press the <strong>Unsubscribe</strong> button.</p><br/>
    ...
    <%--<script type="text/javascript" src="http://ir1.euroinvestor.com/ir/tools/EmailAlertsWithPush/inc/generic_mobileOverlayFix.js"></script>--%>
     <script type="text/javascript" src="http://ir.euroinvestor.com/Tools/EmailAlertsWithPush/inc/genericIR_mobileOverlayFix.js?v=4"></script>
