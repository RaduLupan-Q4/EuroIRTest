...
<div class="IRCalendar">
    ...
    <%--<table class="IRCalendarModule table-look responsive">
        <tr>
            <th class="calendarDate">Date</th>
            <th class="calendarInformation">Information</th>
        </tr>
        <tr>
            ...
            <td class="calendarInformation">
                ...
                <div class="calendarMoreInfo">
                    ...
                    <span class="toggle" style="display: none; width: 100%; max-width: 400px; float: left; padding: 10px;">
                        <strong>Start date: </strong><span class="startDate">20150908T070000Z</span><br />
                        <strong>End date: </strong><span class="endDate">20150908T093000Z</span><br />
                        <strong>Location: </strong><span class="location">Frankfurt, Germany</span>
                    </span>
                </div>
            </td>
        </tr>
