            ...
            <div class="IRNewsTool table-look horizontal responsive">
                ...
                <div class="NewsDataGroupWrapper">
                    ...
                    <div class="IRDataGroup" id="{{storyID}}">
                        <div class="IRData IRNewsCategoryTitle column-first">News Category</div>
                         <div class="IRData IRTitle" id="{{ShowCategoryShort categories}}">{{headline}}</div>
                        <div class="IRData IRDate " id="{{showDateWithFormat timestamp 'YYYY-MMM-DD'}}">{{showDateWithFormat timestamp 'DD MMMM'}} <br />{{showDateWithFormat timestamp 'YYYY'}}</div>
