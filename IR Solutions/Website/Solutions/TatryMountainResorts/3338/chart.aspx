...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    <table class="IRQuoteModule table-look horizontal responsive">
        <tr>
            ...
            <th class="Header lastPrice column-first">{{headers/t_last}}</th> 
            <th class="Header prevClose">{{headers/t_previous_close}}</th>
        ...
        <tr>
            ...
            <td class="Data lastPrice column-first">{{decimals stocks/last}} {{stocks/currency}}</td>
