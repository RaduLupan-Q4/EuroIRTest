...
<% 
    // Settings
    string activeClient = "RockroseEnergyPLC";
    int solutionID = 2446;
    int instrumentID = 29726085;
...
If you would like to unsubscribe, please login and press the <strong>Unsubscribe</strong> button.</p><br/>
           ...
           <p>
            ...
            <form action="emailAlerts.aspx">
               ...
               <input type="hidden" name="activeClient" class="activeClient" value="Rockrose Energy Plc" />
                <input type="hidden" name="solutionID" class="solutionID" value="2446" />
                <input type="hidden" name="instrumentID" class="instrumentID" value="29726085" />
