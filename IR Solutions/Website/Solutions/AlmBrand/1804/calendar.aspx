...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.getJSON(getServiceEngingeURL() + 'RequestNewsCalendarPagination?apiversion=1&lcid=' + lcid + '&customerKey=almbrand&solutionID=1804&MaxRows=100&pageno=0&instrumentid=' + instrumentid + '&StartDate=' + convertedDate + '&sortAscDesc=desc', function (data) {
    ...
    function pagination(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            if (i == 0) {
                $('.IRNewsPagination').append("<a href='javascript: onClick=showPage(" + pageNumber + ")' class='IRNewsPageNumber IRPageNumber" + pageNumber + " active' style='display:inline-block'>"
                    + pageNumber + "</a>");
            }
    ...
    $('.calendarReminderFinancial').click(function () {
    ...
    $('.calendarReminderRoadshow').click(function () {
    ...
    function selectPeriod() {
        ...
        $.getJSON(getServiceEngingeURL() + 'RequestNewsCalendarPagination?apiversion=1&lcid=' + lcid + '&customerKey=almbrand&solutionID=1804&MaxRows=20000&pageno=0&instrumentid=' + instrumentid + '&StartDate=' + periodStartDate + '&sortAscDesc=desc', function (data) {
            allData = data.data;
