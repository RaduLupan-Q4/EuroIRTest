...
<li class="tabitem"><a class="clickableTab" listing="2">MFC.PR.A (TSX)</a></li>
...
<li class="tabitem tab-last"><a class="clickableTab" listing="5">MFC.HK (HKEX)</a></li>
        ...
        <div id="tab-1">
            <iframe src="lookup.aspx?listing=0" id="mainIframe"></iframe>
        </div>
    </div>
</div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('.clickableTab').click(function () {
            $('#mainIframe').attr('src', 'lookup.aspx?listing=' + $(this).attr('listing'));
