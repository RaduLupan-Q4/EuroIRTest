var clientStyleOverwrite = new function ()
{
    ...
    this.amountOfNewsHeadlines = 6;
    this.chart_ColourVolumeBars = '#716560';
    this.chart_Colours = ['#007992', '#002395', '#03C03C', '#7FBB0F', '#138808', '#3B444B', '#f17a54', '#dfdb36', '#779ECB', '#FF0000', '#779ECB', '#915C83', '#91877D', '#FF00DC', '#967117', '#9932CC', '#00FF90', '#A4C639', '#B2EC5D', '#CBA135', '#CD9575', '#91877D', '#967117', '#FF8C00', '#779ECB', '#A4C639'];
}
