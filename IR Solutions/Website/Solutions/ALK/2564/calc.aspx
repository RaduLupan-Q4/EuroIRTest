...
<%--<script type="text/javascript">
    setInterval(function(){
        ...
        var listing = urls.substring(70, 71);
       // alert(listing);
        if (listing == "1") {
    ...
    //    var listing = urls.substring(73, 74);
    //    alert(listing);
    //    if (listing == "1") {
    //        $("#selectExchange").val("TEL");
    //    } else {
    ...
    $(document).on("change", "#selectExchange", function () {
        ...
        if (a == "TEL") {
            window.location.replace("http://ir.euroinvestor.com/Solutions/TowerJazz/2246/calc.aspx?listing=1");

        } else {
            window.location.replace("http://ir.euroinvestor.com/Solutions/TowerJazz/2246/calc.aspx?listing=0");
