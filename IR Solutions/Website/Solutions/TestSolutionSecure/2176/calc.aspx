...
<script id="IRCalcTemplate" type="text/x-handlebars-template">
    ...
    <form id="calc-form">
        ...
        <div class="input-row">
            ...
            <div class="input-wrapper" style="width:180px; font-size:12px; text-align:center;  ">
                {{{datepicker 'from'}}}
                {{{selectFromDay}}}
                {{{selectFromMonth}}}
                {{{selectFromYear}}}
        ...
        <div class="input-row">
            ...
            <div class="input-wrapper" style="width:140px;font-size:14px;">
