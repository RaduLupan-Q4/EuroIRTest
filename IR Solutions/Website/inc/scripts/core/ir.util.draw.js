...
function buildNewsTool(newsRawData) {
    ...
    if (typeof ($(".IRNewsModule .IRNewsTool .IRData.IRTitle")) == 'object') {
        //
        //  Remove characters such as Â & ? from headlines.
        //
        $(".IRNewsModule .IRNewsTool .IRData.IRTitle").each(function () {
            $(this).html(newsHeadlineRemoveCharacters($(this).html()));
        });
    }
...
function drawIRChartHTML() {
    ...
    $(globalChartContainer).highcharts('StockChart', {
        ...
        chart: {
            ...
            marginLeft: 10,
            spacingTop: 30,
            marginBottom: clientStyle.chart_ChangePeriodSpacing,
            plotBorderWidth: 1,
