...
function initMomentTimezone() {
    ...
    */
    ...
    if (clientStyle.manualTimeOffset != null) {
...
var IRChartTechnicalAnalysis = {
    ...
    updateTechnicalAnalysis: function (id) {
        ...
        globalActiveTAShort = id.replace("SMA", "");
    ...
    redrawActiveSettings: function (settings) {
        ...
        for (var i = 0; i < settings.length; i++) {
            settingsControls += "<div class=\"settingsPlaceholder\"><span>" + settings[i].name + ":</span><input class=\"setting" + settings[i].name + "\" type=\"text\" value=\"" + settings[i].value + "\" /></div>";
        }
    ...
    clickHandlerUpdateSMA: function () {
        $('.IRChartTechnicalAnalysisActiveSettings .updateButton').off().on('click', function () {
            ...
            var settingPeriod = $('.IRChartTechnicalAnalysisActiveSettings .settingPeriod').val();
    ...
    clickHandlerUpdateMACD: function () {
        ...
        $('.IRChartTechnicalAnalysisActiveSettings .updateButton').off().on('click', function () {
            ...
            var settingFast = $('.IRChartTechnicalAnalysisActiveSettings .settingFast').val();
            var settingSlow = $('.IRChartTechnicalAnalysisActiveSettings .settingSlow').val();
            var settingSignal = $('.IRChartTechnicalAnalysisActiveSettings .settingSignal').val();
    ...
    clickHandlerUpdateBBands: function () {
        ...
        $('.IRChartTechnicalAnalysisActiveSettings .updateButton').off().on('click', function () {
            ...
            var settingPeriod = $('.IRChartTechnicalAnalysisActiveSettings .settingPeriod').val();
            var settingK = $('.IRChartTechnicalAnalysisActiveSettings .settingK').val();
    ...
    clickHandlerUpdateMAES: function () {
        $('.IRChartTechnicalAnalysisActiveSettings .updateButton').off().on('click', function () {
            ...
            var settingPeriod = $('.IRChartTechnicalAnalysisActiveSettings .settingPeriod').val();
            var settingStray = $('.IRChartTechnicalAnalysisActiveSettings .settingStray').val();
    ...
    clickHandlerUpdatePSAR: function () {
        $('.IRChartTechnicalAnalysisActiveSettings .updateButton').off().on('click', function () {
            ...
            var settingAcceleration = $('.IRChartTechnicalAnalysisActiveSettings .settingAcceleration').val();

            requestAnalysisParabolicSar = null;

            console.log(settingAcceleration);
            ...
            IRChartTechnicalAnalysis.redrawActiveSettings([
                { name: 'Acceleration', value: settingAcceleration }
            ]);
