            ...
            if (init) {
                ...
                if (!clipRect) {
                    ...
                    chart[sharedClipKey + 'm'] = markerClipRect = renderer.clipRect(
                        -99, // inc the width of the first marker
	 ...
	 */
        render: function(min, max) {
            var rangeSelector = this,
                ...
                plotLeft = chart.plotLeft - 52, // JRJR
                yAlign,
                buttonLeft;
            ...
            if (!rangeSelector.rendered) {
                ...
                buttonLeft = plotLeft + rangeSelector.zoomText.getBBox().width + 20; //JRJR + 5

                each(rangeSelector.buttonOptions, function(rangeOptions, i) {
                    buttons[i] = renderer.button(
                        rangeOptions.text,
                        buttonLeft,
                        chart.plotTop - 50, //JRJR - 25
                        function() {
