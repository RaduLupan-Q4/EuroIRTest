...
function initHandlebars()
{
    ...
    if (IRMiniQuoteModule) {
        ...
        if (typeof ($('.IRMiniQuoteModule').html()) != "undefined" && typeof ($('#IRMiniQuoteModuleTemplate').html()) != "undefined") {
            var menuSource_MiniQuoteTable = $('#IRMiniQuoteModuleTemplate').html();
            menuTemplate_MiniQuoteTable = Handlebars.compile(menuSource_MiniQuoteTable);
        }
    }
...
function loadTradeData()
{
    ...
    var postRequest = {
        apiversion: clientApiVersion,
        solutionID: clientSolutionID,
        instrumentid: 1000025, // TODO, get this from provider!
        customerKey: clientCustomerKeyRequired,
...
function loadOrdersData()
{
    ...
    var postRequest = {
        apiversion: clientApiVersion,
        solutionID: clientSolutionID,
        instrumentid: 1000024, // TODO, get this from provider!
        customerKey: clientCustomerKeyRequired
    };
...
function buildNewsTool(data, template)
{
    debugStep("buildNewsTool");
    $(".IRNewsModule").html(template(data));
}
