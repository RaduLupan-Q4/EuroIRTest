...
Handlebars.registerHelper('includeIRChartNavigation', function () {
    ...
    if (useIRChartCompare || useIRChartTA || useIRChartTSR || useIRChartCurrencyConversion) {
    ...
    if (useIRChartSettings && (clientStyle.chart_settingsHighLow || clientStyle.chart_settingsDrawType || clientStyle.chart_settingsGraphScale)) {
        ...
        if (clientStyle.chart_settingsDrawType) {
            ...
            ret += '<div class="basicButtonLook selectableItem ' + lactive + '" style="border-color:' + globalChartColours[0] + '" data-type="line">' + translations.t_line + '</div>';
            ret += '<div class="basicButtonLook selectableItem ' + aactive + '" style="border-color:' + globalChartColours[0] + '" data-type="area">' + translations.t_mountain + '</div>';
            ret += '<div class="basicButtonLook selectableItem ' + dactive + '" style="border-color:' + globalChartColours[0] + '" data-type="dot">' + translations.t_dot + '</div>';
            ret += '<div class="basicButtonLook selectableItem ' + cactive + '" style="border-color:' + globalChartColours[0] + '" data-type="candlestick">' + translations.t_candlestick + '</div>';
        }
        if (clientStyle.chart_settingsGraphScale) {
            ...
            ret += '<div class="basicButtonLook selectableItem moder" style="border-color:' + globalChartColours[0] + '" data-type="logarithmic">' + translations.t_log + '</div>';
        }
        if (clientStyle.chart_settingsHighLow) {
            ret += '<div class="IRChartSettingsBodyListHeader">' + translations.t_indicators + '</div>';
            ret += '<div class="basicButtonLook selectableItem highLow" style="border-color:' + globalChartColours[0] + '">' + translations.t_period + ' ' + translations.t_high + '/' + translations.t_low + '</div>';
        }
        ret += '<div class="basicButtonLook" id="IRChartNavigationClearSettings">' + translations.t_clear_all + '</div>';
        ret += '</div>';
        ret += '</div>';
        ret += '</div>';
    }
    ...
    if (useIRChartTA) {
        ...
        ret += '<div class="basicButtonLook color' + globalChartColours[1].replace('#', '') + '" data-color="' + globalChartColours[1] + '" data-type="' + chartTechnicalAnalysisNamesCC.SimpleMovingAverage + '">' + chartTechnicalAnalysisNames.SimpleMovingAverage + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_period + '<input type="number" class="period-list" placeholder="' + translations.t_period + '" data-min="10" min="10"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';

        ret += '<div class="basicButtonLook color' + globalChartColours[2].replace('#', '') + '" data-color="' + globalChartColours[2] + '" data-type="' + chartTechnicalAnalysisNamesCC.ExponentialMovingAverage + '">' + chartTechnicalAnalysisNames.ExponentialMovingAverage + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_period + '<input type="number" class="period-list" placeholder="' + translations.t_period + '" data-min="10" min="10"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';

        ret += '<div class="basicButtonLook color' + globalChartColours[3].replace('#', '') + '" data-color="' + globalChartColours[3] + '" data-type="' + chartTechnicalAnalysisNamesCC.BolingerBands + '">' + chartTechnicalAnalysisNames.BolingerBands + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_period + '<input type="number" class="period-list" placeholder="' + translations.t_period + '" data-min="20" min="20"/></label>' +
            '<label>K<input type="number" class="period-list" placeholder="K" data-min="2" min="2"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';

        ret += '<div class="basicButtonLook color' + globalChartColours[4].replace('#', '') + '" data-color="' + globalChartColours[4] + '" data-type="' + chartTechnicalAnalysisNamesCC.MovingAverageEnvelope + '">' + chartTechnicalAnalysisNames.MovingAverageEnvelope + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_period + '<input type="number" class="period-list" placeholder="' + translations.t_period + '" data-min="10" min="10"/></label>' +
            '<label>' + translations.t_stray + '<input type="number" class="period-list" placeholder="' + translations.t_stray + '" data-min="1" min="1"/></label>' +
            '<input type="hidden" class="period-list hidenIn" value="simple"/>' +
            '<label><input type="radio" name="maetype" class="rad" value="simple" checked/>' + translations.t_simple_moving_average + '</label>' +
            '<label><input type="radio" name="maetype" class="rad" value="exponential"/>' + translations.t_exponential_moving_average + '</label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';

        ret += '<div class="basicButtonLook color' + globalChartColours[5].replace('#', '') + '" data-color="' + globalChartColours[5] + '" data-type="' + chartTechnicalAnalysisNamesCC.ParabolicSAR + '">' + chartTechnicalAnalysisNames.ParabolicSAR + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_acceleration + '<input type="number" class="period-list" placeholder="' + translations.t_acceleration + '" data-min="0.02" min="0.02"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';


        ret += '<div class="IRChartTABodyListHeader">' + translations.t_oscillators + '</div>';
        ret += '<div class="basicButtonLook color' + globalChartColours[7].replace('#', '') + '" data-color="' + globalChartColours[7] + '" data-type="' + chartTechnicalAnalysisNamesCC.CommodityChannelIndex + '">' + chartTechnicalAnalysisNames.CommodityChannelIndex + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_period + '<input type="number" class="period-list" placeholder="' + translations.t_period + '" data-min="10" min="10"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';

        ret += '<div class="basicButtonLook color' + globalChartColours[8].replace('#', '') + '" data-color="' + globalChartColours[8] + '" data-type="' + chartTechnicalAnalysisNamesCC.DirectionalMovementIndex + '">' + chartTechnicalAnalysisNames.DirectionalMovementIndex + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_period + '<input type="number" class="period-list" placeholder="' + translations.t_period + '" data-min="14" min="14"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';
        ret += '<div class="basicButtonLook color' + globalChartColours[6].replace('#', '') + '" data-color="' + globalChartColours[6] + '" data-type="' + chartTechnicalAnalysisNamesCC.MovingAverageConvergenceDivergence + '">' + chartTechnicalAnalysisNames.MovingAverageConvergenceDivergence + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_short + '<input type="number" class="period-list" placeholder="' + translations.t_short + '" data-min="12" min="12"/></label>' +
            '<label>' + translations.t_long + '<input type="number" class="period-list" placeholder="' + translations.t_long + '" data-min="26" min="26"/></label>' +
            '<label>' + translations.t_signal + '<input type="number" class="period-list" placeholder="' + translations.t_signal + '" data-min="9" min="9"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';

        ret += '<div class="basicButtonLook color' + globalChartColours[9].replace('#', '') + '" data-color="' + globalChartColours[9] + '" data-type="' + chartTechnicalAnalysisNamesCC.Momentum + '">' + chartTechnicalAnalysisNames.Momentum + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_period + '<input type="number" class="period-list" placeholder="' + translations.t_period + '" data-min="10" min="10"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';

        ret += '<div class="basicButtonLook color' + globalChartColours[10].replace('#', '') + '" data-color="' + globalChartColours[10] + '" data-type="' + chartTechnicalAnalysisNamesCC.MoneyFlowIndex + '">' + chartTechnicalAnalysisNames.MoneyFlowIndex + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_period + '<input type="number" class="period-list" placeholder="' + translations.t_period + '" data-min="14" min="14"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';

        ret += '<div class="basicButtonLook color' + globalChartColours[11].replace('#', '') + '" data-color="' + globalChartColours[11] + '" data-type="' + chartTechnicalAnalysisNamesCC.RateOfChange + '">' + chartTechnicalAnalysisNames.RateOfChange + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_period + '<input type="number" class="period-list" placeholder="' + translations.t_period + '" data-min="15" min="15"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';

        ret += '<div class="basicButtonLook color' + globalChartColours[12].replace('#', '') + '" data-color="' + globalChartColours[12] + '" data-type="' + chartTechnicalAnalysisNamesCC.RelativeStrengthIndex + '">' + chartTechnicalAnalysisNames.RelativeStrengthIndex + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_period + '<input type="number" class="period-list" placeholder="' + translations.t_period + '" data-min="14" min="14"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';

        ret += '<div class="basicButtonLook color' + globalChartColours[13].replace('#', '') + '" data-color="' + globalChartColours[13] + '" data-type="' + chartTechnicalAnalysisNamesCC.WilliamsPercentR + '">' + chartTechnicalAnalysisNames.WilliamsPercentR + '' +
            '<div class="inputBox">' +
            '<label>' + translations.t_period + '<input type="number" class="period-list" placeholder="' + translations.t_period + '" data-min="10" min="10"/></label>' +
            '<button type="button" class="pop-submit">' + translations.t_add + '</button>' +
            '</div></div>';
    ...
    if (useIRChartTSR) {
        ...
        ret += '<div class="basicButtonLook color002395" data-mode="TSRSimple">' + translations.t_tsr_simple + '</div>';
        ret += '<div class="basicButtonLook color03C03C" data-mode="TSRReinvest">' + translations.t_tsr_reinvest + '</div>';
