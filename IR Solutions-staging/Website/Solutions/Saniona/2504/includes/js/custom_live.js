    ...
    function prepareTranslations() {
        ...
        if (!translationsApplied) {
            ...
            if (typeof ($('.announcementsHeader').html()) != 'undefined') {
                ...
                $.getJSON('https://ir.euroinvestor.com/ServiceEngine/api/json/reply/RequestAnnouncementType?apiversion=1&lcid=1033&customerKey=pushpay&solutionID=2368&MaxRows=9999&pageno=0&instrumentid=1000524&SourceId=1017', function (data) {
                    allData = data;
