...
<script id="IRMiniquoteModuleTemplate" type="text/x-handlebars-template">
    <div class="IRMiniQuoteQuoteModule table-look responsive">
           <div class="quotebox left">
            <div class="title">
                <span class="name formatColourBasedOnPercentageChange">{{showExchangeShort stocks/exchangeName}}</span>
                <span class="last">
            ...
            <div class="time">As of {{showDateWithFormat stocks/tradeTimestamp 'hh:mm A'}} Israel Time on {{showDateWithFormat stocks/tradeTimestamp 'MMM D, YYYY'}}</div>
            <div class="description"><%--{{headers/t_data_is_at_least_15_min_delayed}}--%>Delayed at least 20 minutes.</div>
            <div class="description">See disclaimer in 
                <a target="_top" href="http://ir.redhillbio.com/stockquote.cfm?exchange=TASE">Stock Information</a> page.
            </div>
        </div>
    </div>
