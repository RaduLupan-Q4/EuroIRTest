...
<script id="IRMiniquoteModuleTemplate" type="text/x-handlebars-template">
    ...
    <div class="IRMiniQuoteQuoteModule table-look responsive">
        <div class="miniquoteDetailsWrapper">
            <div class="Data closeDate"><%--{{stocks/exchangeName}}--%>OSE: {{stocks/symbol}} </div>
            ...
            <%--<div class="Data change"><b>{{headers/t_change}}: </b><br />{{decimals stocks/change}} {{stocks/changePercent}} % </div>--%>
