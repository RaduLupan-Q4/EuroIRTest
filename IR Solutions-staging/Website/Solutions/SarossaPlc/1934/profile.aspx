...
<% 
    ...
    site.appendCustomCSSURL = "http://www.investorcom.co.uk/SharePriceChart/SarossaCapitalPlc.css";
...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <div class="profile-wrapper">
        ...
        <b>Sector:</b> Financial Services<br>
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Financial Services</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">BKWBZV6</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">JE00BKWBZV64</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data market-segment">AMSM</td>
                    </tr>
                    <tr>
                        <td class="Header country">Country of register</td>
                        <td class="Data country">Jersey</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data nms">150,000</td>
                    </tr>
                    <tr>
                        <td class="Header date-listed">Date Listed</td>
                        <td class="Data date-listed">16/12/1999</td>
                    </tr>
                </table>
            </div>
