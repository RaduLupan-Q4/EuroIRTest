    ...
    <div>
        <div class="IRNewsTool table-look horizontal responsive">
            <div class="IRHeaderGroup">
                ...
                <div class="IRHeader column-last file-type">LINK/PDF</div>
            </div>
            <div class="NewsDataGroupWrapper">
                {{#each data}}
                <div class="IRDataGroup" id="{{storyID}}">
                    <div class="IRData IRDate column-first" id="{{showDateWithFormat timestamp 'YYYY-MMM-DD'}}">{{showDateWithFormat timestamp 'DD MMMM HH:mm'}}</div>
                    ...
                    <div class="IRData IRDownload">
                        <div class="IRDownloadPDF">
                            ...
                            <a target="_blank" class="downloadPDF" href="{{pdfUrl}}" style="color:#fff;">{{{showRNSPDF pdfUrl}}}</a>
                        </div>
    ...
    function applyIRNewsPagination() {
        ...
        if (IRNewsPaginationApplied) {
            ...
            if (typeof ($('.IRNewsPagination').html()) != 'undefined') {
               ...
               // $('#13427497').attr('onclick', 'window.open("http://ir.euroinvestor.com/Tools/newsArticleHTML.aspx?solutionID=2680&customerKey=oncimmuneholdingsplc&storyID=13427497&language=en", "new_window")');
              
                $('#13427497').html('<div class="IRData IRDate column-first" id="2016-May-25">15 July 07:00</div>' +
                    '<a href="http://ir.euroinvestor.com/Tools/newsArticleHTML.aspx?solutionID=2680&customerKey=oncimmuneholdingsplc&storyID=13427497&language=en" target="_blank" class="IRData IRTitle" id="MSC" style="text-decoration: none; text-transform: none; color: #2D6B86;">CE Mark for EarlyCDT®-Lung</a></div>' +
                    '<div class="IRData IRDownload">' +
                    '<div class="IRDownloadPDF">' +
                    '<a href="http://ir1.euroinvestor.com/IR/Files/RNSNews/30896564/OncimmuneHoldingsPlc_13427497.pdf" class="iconPDF" target="_blank"></a>' +
                    //'&nbsp;<a class="iconPDF" target="_blank" window.open("http://ir1.euroinvestor.com/IR/Files/RNSNews/30896564/OncimmuneHoldingsPlc_13427497.pdf", "new_window")></a>' +
                    '</div>' +
                    '<div class="IRDownloadKB">' +
                    '</div>' +
                    '</div>');
