...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <div class="profile-wrapper">
        ...
        <b>Sector:</b> Technology Hardware & Equipment<br>
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Technology Hardware & Equipment</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">B0P66Q0</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">GB00B0P66Q02</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data nms">500,000</td>
                    </tr>
                    <tr>
                        <td class="Header date-listed">Date Listed</td>
                        <td class="Data date-listed">12/07/2005</td>
                    </tr>
                </table>
            </div>
                ...
                <table class="IRTable table-look responsive">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="Data shares-issued">{{decimal stocks/shareMillions}}m</td>
                        </tr>
                        <tr>
...
<script type="text/javascript">
    ...
    return formatDecimalWithCustomNumberOfDecimal(number, 3);
});
