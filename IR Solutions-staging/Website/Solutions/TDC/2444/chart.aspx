...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <table class="IRQuoteModule table-look horizontal customResponsive">
        <tr>
            <th class="chartName" colspan="3">{{stocks/name}} (OMX: {{stocks/symbol}})</th>
            <th class="updated" colspan="2">{{showTime timestamp}} ET on {{showDateWithFormat timestamp 'DD MMM, YYYY'}}</th>
        </tr>
        <tr>
