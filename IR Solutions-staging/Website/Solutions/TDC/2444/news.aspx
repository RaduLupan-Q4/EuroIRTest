...
<script id="IRNewsTemplate" type="text/x-handlebars-template">
    ...
    <div class="tab-container">
        <span style="float: left; max-width: 100px; line-height: 25px; height: 25px; margin-right: 10px; font-size: 12px;">Year:</span>
        <ul class="list_reset ul-list-tabs">
            ...
            <li style="display: none;" class="li-tab current pointer" id="tab1">{{{newsFiltersSelect 'NasdaqOMXNordic'}}}
            </li>
            ...
            <li class="li-tab tab-3" id="tab3" style="display: none;">
...
<script type="text/javascript">
    ...
    $(function(){
        /*$(".select-date").off('change').on('change','#to-year', function(){
            changeYear();
        });
*/    });
