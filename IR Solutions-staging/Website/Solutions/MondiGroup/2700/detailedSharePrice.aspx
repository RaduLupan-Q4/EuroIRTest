...
<script id="IRQuoteTableHorizontalTemplate" type="text/x-handlebars-template">
    ...
    <div class="iframe-wrapper" style="height: 1080px; width: 100%;">
        ...
        <iframe src="https://irssl.euroinvestor.com/asp/ir/MondiGroup/2016/quote.aspx?listing=1" style="width: 100%; border: none; height: 500px;"></iframe>
    </div>
</script>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        var url = '//ir.euroinvestor.com/ServiceEngine/api/json/reply/RequestClosePriceBundle_ohlC?apiVersion=1&lcid=2057&solutionID=2700&customerKey=mondigroup&numberOfYears=1&instrumentTypes=Peer&instrumentTypes=listing';
