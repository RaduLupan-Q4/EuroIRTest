...
<div class="tabs-container">
        ...
        <div id="container" class="tabs">
            ...
            <div id="tab-1">
                <iframe src="chart.aspx" style="width: 100%; height: 1000px; border: none;"></iframe>
            </div>
            <div id="tab-2">
                <iframe src="chart.aspx?listing=1" style="width: 100%; height: 1000px; border: none;"></iframe>
            </div>
            <div id="tab-3">
                <iframe src="chart.aspx?listing=2" style="width: 100%; height: 1000px; border: none;"></iframe>
            </div>
        </div>
</div>
