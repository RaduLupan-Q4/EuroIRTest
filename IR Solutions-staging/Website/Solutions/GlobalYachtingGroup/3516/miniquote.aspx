...
<script id="IRMiniquoteModuleTemplate" type="text/x-handlebars-template">
    <div class="IRMiniQuoteQuoteModule table-look responsive">
        <h2 class="title">Current Share Price</h2>                 
        <div class="Data last">{{decimals stocks/last}}<span class="p">p</span></div>
        <div class="Data change">{{headers/t_change}}: (<span class="{{formatColour stocks/change}}"><b>{{decimals stocks/change}}</b></span>)p at {{timeAmPm stocks/timestamp}} {{showDateWithFormat timestamp 'DD.MM.YYYY'}}</div>
