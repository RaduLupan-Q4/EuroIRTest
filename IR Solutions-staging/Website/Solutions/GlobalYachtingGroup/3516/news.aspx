    ...
    <script>
        ...
        function loopYear() {
            ...
            $(toOptions.get().reverse()).slice(0, 4).each(function (index, item) {
                ...
                $(".date-wrapper .date-selector:nth-child(4)").addClass('tab-last');
                $(".date-wrapper .date-selector:nth-child(4)").css('margin-right', '0');
            });
        ...
        if (IRNewsPaginationApplied) {}
            ...
            if (typeof ($('.IRNewsPagination').html()) != 'undefined') {
                ...
                $('.IRDownload').hover(function() {
                    $(this).find('.IRDownloadKB').css({ 'color':'#1c74b9', 'text-decoration': 'underline' });
                },
                    function(){
