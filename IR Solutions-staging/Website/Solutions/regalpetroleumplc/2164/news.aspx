    ...
    <div>
        ...
        <div class="IRNewsTool table-look responsive">
            <div class="IRHeaderGroup">
                <%--<div class="IRHeader IRTime column-first">{{headers/t_time}}</div>--%>
            ...
            {{#each data}}
                <div class="IRDataGroup" id="{{storyID}}">
                    <%--<div class="IRData IRTime column-first">{{showTime timestamp}}</div>--%>
                    <div class="IRData IRDate" id="{{showDateWithFormat timestamp 'YYYY-MMM-DD'}}">{{showDate timestamp}}</div>
