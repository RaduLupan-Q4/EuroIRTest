...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.getJSON('/ServiceEngine/api/json/reply/RequestNewsCalendarPagination?apiversion=1&lcid=' + lcid + '&customerKey=almbrand&solutionID=1804&MaxRows=100&pageno=0&instrumentid=' + instrumentid + '&StartDate=' + convertedDate + '&sortAscDesc=asc', function (data) {
            ...
            $("#emailCalendarSignup_submit").click(function () {
                ...
                if (isValidEmailAddress($('#emailCalendarSignup').val()) && checkedValues.length != 0) {
                    ...
                    if (globalActiveLanguage == "da") {
                        ...
                        $('.information t_enter_valid_email').text("Venligst indtast en gyldig mail");
                        $('#dialogueBox_register').show();
                        $('.transparantOverlay').show();
                    } else {
                        $('.verificationImage').attr('src', 'images/information.png');
