        ...
        <div>
            ...
            <div class="IRNewsTool table-look horizontal responsive">
                <div class="IRHeaderGroup">
                    ...
                    <div class="IRHeader file-type column-last">{{headers/t_download_file}}</div>
                </div>


                {{#each data}}
                <div class="IRDataGroup" id="{{storyID}}">
                    <div class="IRData IRDate column-first" id="{{showDateWithFormat timestamp 'YYYY-MMM-DD'}}">{{showDateWithFormat timestamp 'MMM DD, YYYY'}}</div>
