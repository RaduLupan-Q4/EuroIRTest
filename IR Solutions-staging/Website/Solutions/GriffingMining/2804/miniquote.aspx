    ...
    <div class="IRMiniQuoteQuoteModule table-look responsive">
        <div class="miniquoteDetailsWrapper">
              ...
              <div class="sectionCenter">   
                  <div class="Data change"></div> <div class="stockChange">{{decimals stocks/last}} {{stocks/currency}} ({{decimals stocks/changePercent}} %) <span  class="{{showArrow stocks/change}} arrowBottom"></div>
               </div>
               <div class="btn">
               ...
               <iframe src="../2806/miniquote.aspx" scrolling="no"></iframe>
