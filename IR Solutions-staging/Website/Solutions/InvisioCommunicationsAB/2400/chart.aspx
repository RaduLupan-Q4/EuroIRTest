...
<script type="text/javascript">
    ...
    var activeFeatures = ['IRChartTSR', 'IRChartPressRelease'];
</script>
...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    <table class="IRQuoteModule table-look horizontal responsive">
        ...
        <tr>
            ...
            <td class="Data change {{formatColour stocks/change}}"><span class="changePriceWrapper">{{decimals stocks/change}} ({{decimals stocks/changePercent}}%)</span> <span class="{{showArrow stocks/change}}"></span></td>
