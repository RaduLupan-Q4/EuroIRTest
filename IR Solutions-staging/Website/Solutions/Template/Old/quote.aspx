...
<script type="text/javascript" src="<%= IRSite.BaseURL %>/inc/scripts/ir.responsive.horizontal.js") %>"></script>
...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    <table class="IRToolQuoteTable table-look table-look-horizontal quote quote-horizonta responsive-horizontal">
        {{#headers}}
            <tr>
                <th importance="95" class="IRToolQuoteTableItem Header column-first"><</th>
