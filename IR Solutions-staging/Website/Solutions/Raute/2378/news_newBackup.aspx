                ...
                <div class="datepicker">
                    ...
                    <div class="search-filter-wrapper">
                        <div class="search-for-box">
                            <input class="searchText" value="" type="text" placeholder='Search...' onblur="this.placeholder='{{headers/t_searchHere}}'" />
                        </div>
                    </div>
                </div>
        ...
        <div class="IRNewsTool table-look horizontal responsive">
            ...
            {{#each data}}
                ...
                <div class="IRDataGroup" id="{{storyID}}">
                    <div class="IRData IRDate column-first" id="{{showDateWithFormat timestamp 'YYYY-MMM-DD'}}">
