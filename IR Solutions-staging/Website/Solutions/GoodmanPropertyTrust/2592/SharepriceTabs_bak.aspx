...
<div class="tabs-container">
    <div id="container" class="tabs">
        <ul class="tabsWrapper">
            <li class="tabitem tab-1"><a href="javascript:void(0)">Security price information |</a></li>
            <li class="tabitem tab-2"><a href="javascript:void(0)"> Historical price lookup |</a></li>
            <li class="tabitem tab-3"><a href="javascript:void(0)"> Investment calculator</a></li>
        </ul>
