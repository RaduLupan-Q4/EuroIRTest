...
<script id="IRLookupTemplate" type="text/x-handlebars-template">
    ...
    <div id="container" class="tabs">
        <ul class="tabsWrapper">
            <li class="tabitem tab-1"><a href="//ir.euroinvestor.com/Solutions/GoodmanPropertyTrust/2592/chart_secure.aspx"  target="_self">Security price information |</a></li>
            <li class="tabitem tab-2"><a class="current" href="//ir.euroinvestor.com/Solutions/GoodmanPropertyTrust/2592/lookup_secure.aspx"  target="_self">Historical price lookup |</a></li>
