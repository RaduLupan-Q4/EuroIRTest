...
<div class="tabs-container">
    <div id="container" class="tabs">
        <ul class="tabsWrapper">
            <li class="tabitem tab-1"><a href="//ir.euroinvestor.com/Solutions/GoodmanPropertyTrust/2592chart.aspx">Security price information |</a></li>
            <li class="tabitem tab-2"><a href="//ir.euroinvestor.com/Solutions/GoodmanPropertyTrust/2592lookup.aspx">Historical price lookup |</a></li>
            <li class="tabitem tab-3"><a href="//ir.euroinvestor.com/Solutions/GoodmanPropertyTrust/2592calc.aspx">Investment calculator</a></li>
        </ul>
