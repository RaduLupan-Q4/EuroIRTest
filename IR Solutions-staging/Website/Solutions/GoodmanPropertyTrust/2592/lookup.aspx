...
<script id="IRLookupTemplate" type="text/x-handlebars-template">
    ...
    <div id="container" class="tabs">
        <ul class="tabsWrapper">
            ...
            <li class="tabitem tab-2"><a class="current" href="//ir.euroinvestor.com/Solutions/GoodmanPropertyTrust/2592/lookup.aspx"  target="_self">Historical price lookup |</a></li>
