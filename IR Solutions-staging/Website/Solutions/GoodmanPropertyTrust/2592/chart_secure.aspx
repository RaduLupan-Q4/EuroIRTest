...
<div class="tabs-container">
    <div id="container" class="tabs">
        <ul class="tabsWrapper">
            <li class="tabitem tab-1"><a class="current" href="https://ir.euroinvestor.com/Solutions/GoodmanPropertyTrust/2592/chart.aspx" target="_self">Security price information |</a></li>
            <li class="tabitem tab-2"><a href="//ir.euroinvestor.com/Solutions/GoodmanPropertyTrust/2592/lookup_secure.aspx" target="_self">Historical price lookup |</a></li>
            <li class="tabitem tab-3"><a href="//ir.euroinvestor.com/Solutions/GoodmanPropertyTrust/2592/calc_secure.aspx" target="_self">Investment calculator</a></li>
        </ul>
    </div>
</div>
...
<iframe width="100%" height="600" src="https://irssl.euroinvestor.com/asp/ir/GoodmanPropertyTrust/SSL2016/chart.aspx"></iframe>
