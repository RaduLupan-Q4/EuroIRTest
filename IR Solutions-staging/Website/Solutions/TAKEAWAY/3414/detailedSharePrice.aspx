...
<script id="IRQuoteTableHorizontalTemplate" type="text/x-handlebars-template">
    ...
    <table class="IRDetailedSharePrice table-look horizontal responsive-flip">
        ...
        <tr>
            ...
            <th class="Header prevClose column-last">{{t_last}} {{t_close}}</th>
        </tr>
        {{/headers}}
        {{#stocks}}
        <tr>
            ...
            <td class="Data prevClose column-last">{{prevClose}}</td>
        </tr>
        {{/stocks}}
    </table>
...
<h3 class="horizontal-header trades">{{headers/t_share_price_throughout_the_day}}</h3>
    <div class="">
    ...
    <table class="IRTradesModule table-look horizontal responsive" id="scroll-table">
        <tbody style="width: 100%;">
            <thead>
                <tr>
                    <th class="Header column-first trade">{{headers/t_trades}}</th>
                    <th class="Header hidden timestampFull"></th>
                    <th class="Header price column-first">{{headers/t_price}} ({{showCurrency}})</th>
            ...
            {{#if_eq this}}
            <tr>
                <td class="Data hidden timestampFull column-first">{{timestamp}}</td>
                <td class="Data price column-first">{{decimals tradePrice}}</td>
