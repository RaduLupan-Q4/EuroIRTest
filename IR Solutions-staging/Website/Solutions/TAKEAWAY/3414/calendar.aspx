...
<div class="IRCalendar">
    <div class="wrapper2">
        ...
        <div class="calendarRemindAllEncapsulator" id="Encapsulator2">
            ...
            <br />--%>
                ...
                <br />
                <a id="unsibscribeLinkBtn">Unsubscribe</a>
    ...
    <div class="unsubscribeWrapper" style="display: none">
        ...
        <a id="unsubscribeBackBtn" >Back</a>
        <h2 class="t_unsubscribe"></h2>
        <p class="t_unsubscribe_text">
        </p>
        ...
        <div class="unsubscribe">
            ...
            <b>Email</b>
            <br />--%>
            <input tabindex="1" class="informationInput enterInformationLoginEmail" name="enterInformationLoginEmail" id="unsubscribeEmail" type="email" placeholder="Enter email address" />
                ...
                <div class="contentWrapper">
                    <div class="headlineWrapper">
                        ...
                        <div class="CalendarContentWrapper">
                            ...
                            <span class="calendarWebcastAttachment"><a href="{{getLocation keyValueSet 'webcast'}}" target="_parrent">{{getWebcastTitle keyValueSet 'webcasttitle'}}</a></span>
                    ...
                    <div class="calendarMoreInfo">
                        <a href="#/" class="calendarReminder" data-storyid="{{storyId}}" data-eventstarttime="{{convertToISO startTime}}" data-subject="{{headline}}" data-message="{{text}}">Email reminder</a>
                        <%--<form method="post" action="//ir.euroinvestor.com/ServiceEngine/api/json/reply/RequestCalendarICSFile">
                         ...
                         <a class="addtocalendar atc-style-blue">
                            <var class="atc_event">
                                ...
                                <var class="atc_organizer">Takeaway</var>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.getJSON(getServiceEngingeURL() + 'RequestNewsCalendarPagination?apiversion=1&lcid=1033&customerKey=TAKEAWAY&solutionID=3414&MaxRows=100&pageno=0&instrumentid=1002108&StartDate=' + convertedDate + '&sortAscDesc=asc' + '', function (data) {

            var selectElement = $("#period");
            var allData = data;
            //   var allData = { "data": [{ "storyId": 13387493, "headline": "LOOOOOOOOOOL", "text": "", "startTime": "2016-11-10T23:00:00.0000000", "keyValueSet": [{ "key": "ToolId", "value": "78" }, { "key": "TimeZone", "value": "Central European Standard Time" }, { "key": "eventstarttime", "value": "2016-11-10T23:00:00.0000000" }, { "key": "location", "value": "" }, { "key": "webcasttitle", "value": "" }, { "key": "webcast", "value": "" }] }, { "storyId": 13387493, "headline": "Interim information, third quarter 2016", "text": "", "startTime": "2016-11-10T07:00:00.0000000", "keyValueSet": [{ "key": "ToolId", "value": "78" }, { "key": "TimeZone", "value": "Central European Standard Time" }, { "key": "eventstarttime", "value": "2016-11-10T07:00:00.0000000" }, { "key": "location", "value": "" }, { "key": "webcasttitle", "value": "" }, { "key": "webcast", "value": "" }] }, { "storyId": 13387492, "headline": "Quiet period prior to the third quarter 2016 announcement", "text": "", "startTime": "2016-10-20T06:00:00.0000000", "keyValueSet": [{ "key": "ToolId", "value": "78" }, { "key": "TimeZone", "value": "Central European Standard Time" }, { "key": "eventstarttime", "value": "2016-10-20T06:00:00.0000000" }, { "key": "eventendtime", "value": "2016-10-20T07:00:00.0000000" }, { "key": "location", "value": "" }, { "key": "webcasttitle", "value": "" }, { "key": "webcast", "value": "" }, { "key": "attachmentDA", "value": "" }, { "key": "attachmentEN", "value": "" }] }], "instrumentID": 1000589, "version": 0 };
    ...
    Handlebars.registerHelper('showEventTimeSpan', function (objects, format) {
        ...
        var startTime = getObjects([objects], 'key', 'eventstarttime');
        var eventendtime = getObjects([objects], 'key', 'eventendtime');
        var startTimeDate = new Date(startTime);
        var tString = moment(startTimeDate).format('HH:mm');
        if (tString.indexOf('00:00') >= 0 && eventendtime.length === 0) return '';


        //check if event has en endtime 
        if (eventendtime.length === 0) {
            var newEndDate = startTime;
        ...
        var start = moment(startTimeDate).format('HH:mm');
        var end = moment(eventendtime).format('HH:mm');

        if (start == '00:00' && end == '00:00') {
            return;
        } else {
            return moment(startTimeDate).format(format) + ' - ' + moment(eventendtime).format(format);
        ...
        if (!customXApplied) {
            ...
            $(document).on('click', '#emailCalendarSignup_submit', function () {
                ...
                var checkedValues = $('.calendarReminder_checked').map(function () {
                    ...
                    var eventStartTime = $(this).data("eventstarttime");
