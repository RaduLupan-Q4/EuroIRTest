var clientStyleOverwrite = new function ()
{
    ...
    this.chart_DefaultPeriodSelected = 'm3';
    this.chart_CustomTooltipUseFullOHLCV = true;
    this.chart_VolumeYaxis = true; //enable Volume y-axis on left side of chart
    this.chart_VolumeHeight =  40; // percentage where 40 is 40% - values from 0-100
