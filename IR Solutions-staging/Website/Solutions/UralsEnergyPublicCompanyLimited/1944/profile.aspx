...
<% 
    ...
    site.appendCustomCSSURL = "http://www.investorcom.co.uk/SharePriceChart/UralsEnergy.css";
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Oil, Gas & Coal</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">B0FHR59</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">CY0000111027</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data nms">50000</td>
                    </tr>
                    <tr>
                        <td class="Header date-listed">Date Listed</td>
                        <td class="Data date-listed">09/08/2005</td>
                    </tr>
                </table>
            </div>
