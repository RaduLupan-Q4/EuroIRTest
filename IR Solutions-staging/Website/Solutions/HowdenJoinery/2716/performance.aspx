    ...
    <table class="IRPerformanceModule table-look horizontal responsive">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="Data months1">{{decimals m1}}</td>
                <td class="Data months3">{{decimals m3}}</td>
                <td class="Data months6">{{decimals m6}}</td>
                <td class="Data column-last year1">{{decimals y1}}</td>
            </tr>
            {{/dataListings}}
        </tbody>
