...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <h2 style="border-bottom: 1px solid #1390A4"><b>{{headers/t_share_info}}</b></h2>
    <br />
        ...
        <div class="table-wrapper">
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive" id="profile-table">
                    ...
                    <tr>
                        <td class="Header profile isin">{{headers/t_exchange}}</td>
                        <td class="Data profile isin">{{stocks/exchangeName}}</td>
                    </tr>
                    <tr>
                        <td class="Header profile low-value">{{headers/t_low}} {{headers/t_price}} (EUR)</td>
                    ...
                    <tr>
                        <td class="Header profile shares-issued">{{headers/t_shares_outstanding}}</td>
                        <td class="Data profile shares-issued">{{decimals stocks/shareMillions}} m</td>
                    </tr>
                    <tr>
                        <td class="Header profile market-cap">{{headers/t_market_cap}} (EUR)</td>
