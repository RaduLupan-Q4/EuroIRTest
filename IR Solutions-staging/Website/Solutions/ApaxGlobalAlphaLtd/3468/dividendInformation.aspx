...
<script id="IRDataTemplate" type="text/x-handlebars-template">
    ...
    <table class="IRDividendInformation table-look responsive">
        <tr>
            ...
            <th class="Header dividend"><span class="mobileOnly">Ann-<br />ounced</span><span class="desktopOnly">{{headers/t_announced}}</span></th>
        ...
        <tr>
            ...
            <td class="Data"><span class="mobileOnly">{{showDateWithFormat declarationDate 'DD MMM YYYY'}}</span><span class="desktopOnly">{{showDateWithFormat declarationDate 'DD MMMM YYYY'}}</span></td>
            <td class="Data"><span class="mobileOnly">{{showDateWithFormat paymentDate 'DD MMM YYYY'}}</span><span class="desktopOnly">{{showDateWithFormat paymentDate 'DD MMMM YYYY'}}</span></td>
