...
$.getJSON(getServiceEngingeURL() + 'RequestDividendBundle?apiversion=' + clientApiVersion + '&lcid=1033&solutionID=' + clientSolutionID + '&customerKey=' + clientCustomerKeyRequired + '&numberOfYears=100&period=10' + requestPreviewFromURL(), function (data) {
    allData = data;
    console.log(data);
