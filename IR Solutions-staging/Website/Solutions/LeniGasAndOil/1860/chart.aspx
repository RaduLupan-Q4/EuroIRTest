...
<script type="text/javascript">
    var activeModules = ['IRQuote', 'IRQuoteMulti', 'IRChart'];
...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    <table class="IRQuoteModule table-look horizontal responsive">
        <tr>
            ...
            <th class="Header changePercent">%</th>
        ...
        <tr>
            ...
            <td class="Data changePercent {{formatColour stocks/change}}">({{decimals stocks/changePercent}}%) <span class="{{showArrow stocks/change}}"></span></td>
                ...
                <table class="IRTable table-look responsive">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="Data industry">Exploration & Production</td>
                        </tr>
                        <tr>
                            <td class="Header shares-issued">{{headers/t_number_of_shares}} (mill.)</td>
                            <td class="Data shares-issued">{{toLocal stocks/shareMillions}}</td>
                        </tr>
                        <tr>
                            <td class="Header market-cap">{{headers/t_market_cap}} (GBP mill.)</td>
                            <td class="Data market-cap">{{showLondonMarketCapM stocks/marketCap}}</td>
                        </tr>
                    </tbody>
                </table>
            </div>
