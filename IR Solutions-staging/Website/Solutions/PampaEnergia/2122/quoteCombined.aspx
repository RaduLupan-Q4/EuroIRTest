...
<div class="IRQuoteCombinedModuleWrapper">
	<div class="IRQuoteCombinedModule instrumentSelection">
		...
		<div id="selectedPampa" class="selectedPampa" style="float: left; width: 110px; height: 35px; text-align: left; cursor: pointer;">
			<span class="instrument CUR CUR0" id="1000182" onmouseover="reload(0);">
				<img alt="" style="top: 2px; height: 20px;" src="pics/PampaEnergiaNew.jpg" />
				(NYSE)</span>
			<span>&nbsp;/&nbsp;</span>
