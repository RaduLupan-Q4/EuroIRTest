...
<script type="text/javascript">
    ...
    var activeFeatures = ['IRChartTechnicalAnalysis', 'IRChartCompare'];
</script>
...
<script id="IRChartModuleTemplate" type="text/x-handlebars-template">
    ...
    <br />
    Advanced Analysis (below chart short):<br /><br />
    {{{includeIRChartTechnicalAnalysis 'short'}}}

    <%--<div style="clear: both"></div><br />

    Advanced Analysis (below chart long):<br /><br />
    {{{includeIRChartTechnicalAnalysis 'long'}}}--%>
