...
<script id="IRQuoteTableHorizontalTemplate" type="text/x-handlebars-template">
    <h3 class="horizontal-header" style="padding-top: 0px;">{{headers/t_exchange_information}}</h3>
    ...
    <h3 class="vertical-header" style="padding-top: 0px;">{{headers/t_exchange_information}}</h3>
    ...
    <h3 class="vertical-header">{{headers/t_current_share_price_information}}</h3>
    <div class="divideLine vertical"></div>
    <table class="IRDetailedSharePrice table-look vertical responsive-flip">
    ...
    <h3 class="vertical-header">{{headers/t_high_low_share_price_information}}</h3>
    <div class="divideLine vertical"></div>
    <table class="IRDetailedSharePrice table-look vertical responsive-flip">

        <tr>
            {{#headers}}<th class="Header prev-close" style="width: 50%;">{{t_prev_close}}</th>
            {{/headers}}
           {{#stocks}}<td class="Data prev-close">{{decimals last}}</td>
            {{/stocks}}
        </tr>
        <tr>
