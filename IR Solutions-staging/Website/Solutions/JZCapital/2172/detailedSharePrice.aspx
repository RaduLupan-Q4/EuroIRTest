...
<script id="IRQuoteTableHorizontalTemplate" type="text/x-handlebars-template">
    <div class="quote">
        <div class="current" style="">{{decimals stocks/last}}<span style="color: #555555; font-size: 18px;">{{stocks/currency}} </span></div>
    ...
    <div class="iframe-wrapper" style="height: 500px;">
        <h3>Share Price Throughout the Day ({{stocks/currency}})</h3> 
        <div class="divideLine"></div>
        <iframe src="http://ir1.euroinvestor.com/asp/ir/JZCP/detailedSharePrice.aspx" style="width: 100%; border: none; height: 500px;"></iframe>
    </div>
