...
<script id="IRQuoteTableHorizontalTemplate" type="text/x-handlebars-template">
    ...
    <h2 style="float:left; margin-right: 10px;">Current Share Price: {{decimals stocks/last}}p </h2><span class="formatColour"> {{decimals stocks/change}}p</span>
    ...
    <iframe src="http://ir1.euroinvestor.com/asp/ir/WalkerGreenbank/detailedSharePrice.aspx" style="width: 100%; border: none; height: 500px;"></iframe>
    </div>
