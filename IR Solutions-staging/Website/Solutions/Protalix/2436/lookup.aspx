...
<script id="IRLookupTemplate" type="text/x-handlebars-template">
    ...
    <form id="lookup-form" method="POST">
        ...
        <div class="input-row IRChangeListingWrapper">
            <label for="from-datepicker" class="input-label from-label IRChangeListingLabel">{{t_change_listing}}:</label> 
            <div class="input-wrapper inputListingWrapper">
