...
$(function () {
    ...
    function promiseModule() {
        ...
        if (ModulesList.IRChartModule.active) {
            ...
            $.when(ResponseData.requestClosePriceListingData, ResponseData.requestClosePriceOtherData, ResponseData.requestTranslationsData).done(function (closePriceListingData, closePriceOtherData) {
