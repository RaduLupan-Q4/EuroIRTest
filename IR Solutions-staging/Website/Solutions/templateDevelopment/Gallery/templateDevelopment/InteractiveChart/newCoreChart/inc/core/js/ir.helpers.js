...
Handlebars.registerHelper('includeIRChartNavigation', function () {
    ...
    if (FeaturesList.IRChartCurrencyConversion.use) {
        $.merge(globalDefaultCurrencyList, clientStyle.chart_plusCurrency);
        ret += '<div class="IRChartCC">';
        ret += '<div class="IRChartCCHeader">' + translations.t_currency + '</div>';
        ret += '<div class="IRChartCCBody">';
        ret += '<div class="IRChartCCBodyList">';
        globalDefaultCurrencyList.forEach(function (value) {
...
Handlebars.registerHelper('includeChartTypeChange', function () {
    ...
    if (typeof(chartTypes) !== 'undefined') {
        ...
        ret += '<div class="diagramSelect" data-charttype="diagramArea">' + translations.t_mountain + '</div>';
