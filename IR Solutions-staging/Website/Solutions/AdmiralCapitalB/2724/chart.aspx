...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
 <script type="text/javascript">
    ...
    <div class="companyInfoWrapper">
        ...
        <div class="updated"><%--<span>{{headers/t_updated}}: </span>--%><span>{{showDateWithFormat stocks/timestamp 'DD. MMMM YYYY'}}</span></div>
    </div>
    ...
    <table class="IRQuoteModule table-look horizontal customResponsive">
        ...
        <tr>
            <td class="Data symbol column-first" rowspan="3" style="vertical-align: middle" id="chartLast">{{decimals stocks/last}}<span style="font-size:16px;">{{stocks/currency}}</span></td>
            <%--<td class="Data last">{{stocks/currency}}</td>--%>
