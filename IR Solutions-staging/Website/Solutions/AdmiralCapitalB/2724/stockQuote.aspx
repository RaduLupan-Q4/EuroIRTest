...
<script id="IRMiniquoteChartModuleTemplate" type="text/x-handlebars-template">
        ...
        <div class="stockQuote table-wrapper">
            <table class="IRMiniquoteChart table-look horizontal">
                ...
                <tr>
                    <td class="Info">{{stocks/name}}</td>
                </tr>
                <tr>
                    <td class="Info">(OMX : {{stocks/symbol}})</td>
                </tr>
            </table>
            <%--<button type="submit" class="submit" onclick="parent.document.location.href='http://www.demant.com/investor-relations/shareholder-information/'">Stock Chart</button>--%>
            <a href=" http://admiralcapital.dk/investor-relations/" target="_parent" class="link btn">{{headers/t_read_more}}</a>
        </div>
    </script>
...
<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (style == 'dark') {
                ...
                $('head').append('<link rel="stylesheet" type="text/css" href="stockQuote_dark.css?v=12345">');

            } else {
                $('head').append('<link rel="stylesheet" type="text/css" href="stockQuote_light.css?v=12345">');
