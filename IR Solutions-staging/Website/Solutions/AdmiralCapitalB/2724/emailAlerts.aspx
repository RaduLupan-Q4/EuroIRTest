...
<% 
    // Settings
    string activeClient = "AdmiralCapitalB";
    int solutionID = 2724;
    int instrumentID = 23656484;
...
<head>
    ...
    <link rel="stylesheet" href="//irssl.euroinvestor.com/ir/tools/EmailAlertsWithPush/inc/generic.css" />
        ...
        <div class="content">
            ...
            <div class="pageRegister">
                ...
                <form action="emailAlerts.aspx">
                    ...
                    <input type="hidden" name="companyAnnoucementLanguage" value="Danish" class="companyAnnoucementLanguage" id="companyAnnoucementLanguage" />
