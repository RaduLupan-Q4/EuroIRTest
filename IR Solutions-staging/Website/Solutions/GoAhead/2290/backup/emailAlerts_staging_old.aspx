...
<head>
    ...
    <link rel="stylesheet" href="generic.css?v=145087256229" />
    <link rel="stylesheet" href="emailAlerts.css?v=145087256229" />
            ...
            <div class="blockOuter">
                ...
                <form action="emailAlerts.aspx">
                    ...
                    <div class="blockOuter">
                        ...
                        <h2 class="header">
							<div class="loginText">If you are already subscribed to this service, please <a class="cleanLink OLDformUnsubscribe OLDunsubscribeNextToButton loginButton">Login</a></div>
                        ...
                        <div class="subGroup">
									...
									<label style="cursor:pointer;"><input type="radio" class="ReleaseRSS" name="release" value="checked" checked="checked"> Yes</label>
...
<!--
    ...
    <script type="text/javascript" src="genericIR_mobileOverlayFix.js?v=24"></script>
                    ...
                    success: function (userData) {
                        if ((userData.userExist+'') == 'True') {
                            ...
                            if (country.length > 1) {
                                ...
                                $('#enterInformationCountry option[value=' + userData.optional_country + ']').attr('selected', 'selected');
                            }
            ...
            $('#loginscreen_cancelButton').click(function () {
				...
				$('input[name=release]').change(function(){
				    ...
				    if (clickedRadiobutton == 'checked') {
						$('#ReleaseRSS').attr('checked', 'checked');
					} else {
						$('#ReleaseRSS').removeAttr('checked');
					}
