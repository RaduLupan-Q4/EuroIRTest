...
<script type="text/javascript" src="inc/ir.calc.js?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("inc/ir.calc.js")).Ticks.ToString()%>"></script>
<script type="text/javascript">
