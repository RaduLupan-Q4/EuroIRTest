...
<% 
    // Settings
    string activeClient = "James Fisher";
    int solutionID = 2140;
    int instrumentID = 1210;
    ...
    string titleReleasesC = "Additional information";
    //
...
<body style="font-size: 16px; ">
    ...
    <div class="content">
        ...
        <div class="pageRegister">
            ...
            <div class="subPageLogin">
                ...
                <h2 class="header" style="padding-top: 10px;">Login</h2>
             <!--   <p>
                ...
                <form action="emailAlerts.aspx">
                    ...
                    <p style="float: left; width: 100%;">
                        If you have already subscribed, please enter your email address here, and login to edit your preferences.<br />
                ...
                <div class="blockOuter indent">
                    <label>
                        <span class="checkboxOuter">
                            <input tabindex="7" type="checkbox" checked="checked" class="checkboxRelease ReleasesA" id="ReleasesA" />
                        </span>
                    ...
                    <label>
                        <span class="checkboxOuter">
                            <input tabindex="8" type="checkbox" checked="checked" class="checkboxRelease ReleasesC" id="ReleasesC" />
                        </span>
    ...
    <%--<script type="text/javascript" src="https://irssl.euroinvestor.com/ir/tools/EmailAlertsWithPush/inc/generic_mobileOverlayFix.js"></script>
     <script type="text/javascript" src="//ir.euroinvestor.com/Tools/EmailAlertsWithPush/Inc/genericIR_mobileOverlayFix.js"></script>--%>
