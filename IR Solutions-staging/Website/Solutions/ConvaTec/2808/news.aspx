    ...
    function applyIRNewsPagination() {
        ...
        if (IRNewsPaginationApplied) {
            ...
            if (typeof ($('.IRNewsPagination').html()) != 'undefined') {
                ...
                var paginationTmp = "";
                paginationTmp += '<div class="IRNewsPaginationPageNew IRNewsPaginationPagePrev" style="display:none; visibility:hidden;" id="prev">&nbsp;</div>';
                ...
                paginationTmp += '<div class="IRNewsPaginationPageNew IRNewsPaginationPageNext" id="next" style="display:none;">&nbsp;</div>';
