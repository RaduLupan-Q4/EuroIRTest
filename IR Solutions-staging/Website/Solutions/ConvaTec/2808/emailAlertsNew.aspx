...
<style>
    @font-face {
        ...
        src: url('fonts/MontserratRegular.eot') format('embedded-opentype'), url('fonts/MontserratRegular.ttf') format('truetype'), url('fonts/MontserratRegular.woff') format('woff');
    }
...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <h2>Your Email Alerts</h2>
    <p>Please select the alerts that you would like to receive:</p>
    <div class="sharePriceAlert-wrapper">


        <%--  <div class="alertType-box">
		<input id="alertType_shareDelekDrilling" class="alertTypeCheckbox" type="checkbox" />
		<div class="alertType-subbox">
			<label for="alertType_shareDelekDrilling" class="alertTypeLabel">Delek Drilling</label>
		</div>
	</div>

    <div class="alertType-box">
    <input id="alertType_shareAvnerOil" class="alertTypeCheckbox" type="checkbox" />
		<div class="alertType-subbox">
			<label for="alertType_shareAvnerOil" class="alertTypeLabel">Avner Oil</label>
		</div>
    </div>--%>
	...
	<div class="alertType-box">
        ...
        <%--				</p>
				<br />
				<div class="inputLabel inputLabel_thresshold">{{headers/t_low}}</div><input class="" id="inputLabel_thresshold_low" type="text" placeholder="" />&nbsp;&nbsp;{{stocks/currency}}<br />
				<div class="inputLabel inputLabel_thresshold">{{headers/t_high}}</div><input class="" id="inputLabel_thresshold_high" type="text" placeholder="" />&nbsp;&nbsp;{{stocks/currency}}
			</div>
		</div>
	</div>
	<div class="alertType-box">
		...
		<div class="alertType-subbox">
			...
			<div class="alertTypeDescription"><span>{{headers/t_notify_me_when_the_share_price_changes_more_than_price_percent_in_one_day_part1}}</span><input id="percentChange" class="inlineInputText" type="text" placeholder="" /><span>{{headers/t_notify_me_when_the_share_price_changes_more_than_price_percent_in_one_day_part2}}</span></div>
		</div>
	</div>--%>
        ...
        <div class="alertType-box">
            ...
            <div class="alertType-subbox">
                ...
                <label class="alertTypeLabel alertTypeSubLabel">
                    <input class="alertTypeSubCheckbox alertType_ alertType_1" type="checkbox" />{{headers/t_material_events}}</label>
                <label class="alertTypeLabel alertTypeSubLabel">
                    <input class="alertTypeSubCheckbox alertType_ alertType_2" type="checkbox" />{{headers/t_holdings_of_principal_shareholders}}</label>
                <label class="alertTypeLabel alertTypeSubLabel">
                    <input class="alertTypeSubCheckbox alertType_ alertType_3" type="checkbox" />{{headers/t_quarterly_and_annual_financial_reports}}</label>
                <label class="alertTypeLabel alertTypeSubLabel">
                    <input class="alertTypeSubCheckbox alertType_ alertType_4" type="checkbox" />{{headers/t_prospectuses_and_shelf_offer_reports}}</label>
                <label class="alertTypeLabel alertTypeSubLabel">
                    <input class="alertTypeSubCheckbox alertType_ alertType_5" type="checkbox" />{{headers/t_general_meetings}}</label>
                <label class="alertTypeLabel alertTypeSubLabel">
                    <input class="alertTypeSubCheckbox alertType_ alertType_6" type="checkbox" />{{headers/t_corporate_officers}}</label>
                <label class="alertTypeLabel alertTypeSubLabel">
                    <input class="alertTypeSubCheckbox alertType_ alertType_7" type="checkbox" />{{headers/t_miscellaneous}}</label>
            </div>
        </div>
...
<div class="unsubscribe-wrapper">
    ...
    <div class="register-wrapper">
        ...
        <div class="register-box">
            <div class="inputLabel">{{headers/t_email_address}}</div>
            <input class="register_emailAddress" type="text" />
        </div>
        <div class="register-box">
            <div class="inputLabel">{{headers/t_first_name}}</div>
            <input class="register_firstName" type="text" />
        </div>
        <div class="register-box">
            <div class="inputLabel">{{headers/t_surname}}</div>
            <input class="register_surName" type="text" />
        </div>
        <div class="register-box">
            <div class="inputLabel">{{headers/t_company}}</div>
            <input class="register_company" type="text" />
        </div>
        <div class="register-box">
            <div class="inputLabel">{{headers/t_country}}</div>
            <input class="register_country" type="text" />
        </div>
    </div>
...
<script type="text/javascript" src="convaTec.js"></script>
