...
$.getJSON('http://devir.euroinvestor.com/ServiceEngine/api/json/reply/RequestKeyFigureTransactionData?apiversion=1&lcid=1033&solutionID=' + solutionID + '&instrumentid=' + instrumentID + '&customerKey=' + customerKey + '', function (data) {
...
//this is used to check wether the handlebar is equal to a string
