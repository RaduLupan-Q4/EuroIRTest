...
<script type="text/javascript">
    ...
    var activeFeatures = ['IRChartNews', 'StockDataInstrumentTypeOther', 'IRChartCompare'];
</script>
...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    <table class="IRQuoteModule table-look horizontal responsive">
            ...
            <tr>
                ...
                <td class="Data marketCap">{{showMarketCapInSpecificCurrencyM stocks/marketCap 'DKKEUR'}} m</td>
