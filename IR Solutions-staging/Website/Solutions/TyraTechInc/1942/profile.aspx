...
<% 
    ...
    site.appendCustomCSSURL = "http://www.investorcom.co.uk/SharePriceChart/TyraTech.css";
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Chemicals</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">B1WT4G5</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">USU890581080</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data nms">7500</td>
                    </tr>
                    <tr>
                        <td class="Header date-listed">Date Listed</td>
                        <td class="Data date-listed">06/01/2007</td>
                    </tr>
                </table>
            </div>
                ...
                <table class="IRTable table-look responsive">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="Data market-cap">£{{showMarketCapM_costum_for_tyraTech_TYR stocks/marketCap}}m</td>
                        </tr>
                    </tbody>
                </table>
            </div>
