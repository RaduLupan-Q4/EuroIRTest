...
<% 
    ...
    site.appendCustomCSSURL = "http://www.investorcom.co.uk/SharePriceChart/OptibiotixHealthPlc.css";
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">TBA</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">TBA</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">TBA</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data market-segment">TBA</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data nms">TBA</td>
                    </tr>
                    <tr>
                        <td class="Header date-listed">Date Listed</td>
                        <td class="Data date-listed">17/08/2015</td>
                    </tr>
                </table>
            </div>
