            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data isin">SG9999015259</td>
                    </tr>
                    <tr>
                        <td class="Header market-segment">Par</td>
                        <td class="Data market-segment">0</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">Inst Type</td>
                        <td class="Data sedol">ORD</td>
                    </tr>
                    <tr>
                        <td class="Header market-sector">Market Sector</td>
                        <td class="Data market-sector">ISDX Growth Market</td>
                    </tr>
                    ...
                    <tr>
                        <td class="Header nms">MiFID Status</td>
                        <td class="Data nms">MTF</td>
                    </tr>                  
                    <tr>
                        <td class="Header date-listed">Date Listed</td>
                        <td class="Data date-listed">23/09/2016</td>
                    </tr>
                </table>
            </div>
