...
<% 
    // Settings
    string activeClient = "Corero";
    int solutionID = 2576;
    int instrumentID = 3834512;
    bool showLoginToUnsubscribe = true;
    bool showEuroInvestorDisclaimer = false;

    //string linkToPrivacyStatement = "//www.smith-nephew.com/privacy-statement/";
...
<head>
    ...
    <link rel="stylesheet" href="//ir1.euroinvestor.com/ir/tools/EmailAlertsWithPush/inc/generic.css" />
...
If you would like to unsubscribe, please login and press the <strong>Unsubscribe</strong> button.</p><br/>
            ...
            <form action="emailalerts.aspx">
                ...
                <div class="blockNoBorder">
                    ...
                    <div class="blockInner">
                        ...
                        <div class="inputText">
                            <input tabindex="1" class="inputTextField unsubscribeEmail buttonStyle" name="unsubscribeEmail" type="text" value="" />
                        </div>
                    </div>
    ...
    <%--<script type="text/javascript" src="//ir1.euroinvestor.com/ir/tools/EmailAlertsWithPush/inc/generic_mobileOverlayFix.js"></script>--%>
