...
<% 
    // Settings
    string activeClient = "OPG Power Ventures Plc";
    int solutionID = 2614;
    int instrumentID = 1181089;
...
<head>
    ...
    <link rel="stylesheet" href="http://ir.euroinvestor.com/tools/EmailAlertsWithPush/inc/generic.css" />
    ...
    <div class="content">
        ...
        <div class="pageRegister">
           ...
           <p>
                ...
                Enter your email address and a little information about yourself, and then click on the <strong>Submit</strong> button below (*indicates a required field).
            </p>
            ...
            <form action="emailAlerts.aspx">
                ...
                <div class="blockOuter">
                    ...
                    <div class="blockInner">
                        ...
                        <div class="inputText">
                            <input tabindex="2" placeholder="<%= titleEmailAdress %>* " class="informationInput enterInformationEmail" name="enterInformationEmail" type="text" value="" id="enterInformationEmail" />
                        </div>
                    </div>
                    ...
                    <div class="blockInner">
                        ...
                        <div class="inputText">
                            <input tabindex="3" placeholder="  <%= titleFirstName %>* " class="informationInput enterInformationFirstName" name="enterInformationFirstName" type="text" value="" id="enterInformationFirstName" />
                        </div>
                    </div>
                    ...
                    <div class="blockInner">
                        ...
                        <div class="inputText">
                            <input tabindex="4" placeholder="<%= titleLastName %>* " class="informationInput enterInformationLastName" name="enterInformationLastName" type="text" value="" id="enterInformationLastName" />
                        </div>
                    </div>
                    ...
                    <div class="blockInner">
                        ...
                        <div class="inputText">
                            <input tabindex="5" placeholder="<%= titleCompany %>" class="informationInput enterInformationCompany" name="enterInformationCompany" type="text" value="" id="enterInformationCompany" />
                        </div>
                    </div>
                    ...
                    <div class="blockInner">
                        ...
                        <div class="inputText">                           
                            <input tabindex="6" placeholder="<%= titleCountry %>" class="informationInput enterInformationCountry" name="enterInformationCountry" type="text" value="" id="enterInformationCountry" />
                        </div>
                    </div>
...
<%--                        <br>
                        <br>
                        <br>--%>
                        <input class="formLogin buttonStyle clearInput" type="button" value="Submit" />
                    </div>
                </form>
    ...
    <%--<script type="text/javascript" src="http://ir.euroinvestor.com/tools/EmailAlertsWithPush/inc/generic_mobileOverlayFix.js"></script>--%>
...
<%--<script>
    ...
    function prepareCustomX() {
        if (!customXApplied) {
            if (typeof ($('.pageRegister').html()) != 'undefined') {
                $('.closePopup').click(function() {
                    $('.subPageLogin').css('display', 'block');
                    $('.subPageLoginConfirm').css('display', 'none');
