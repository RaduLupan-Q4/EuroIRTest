...
<link rel="stylesheet" type="text/css" media="screen" href="includes_keyfigures/css/jquery.mCustomScrollbar.css"/>
...
<div class="wrapper">
    ...
    <div class="table-box scrollable mCustomScrollbar light" data-mcs-theme="dark-thick">
        <div id="IRData"></div>
    </div>
    ...
    <script id="IRDataTemplate" type="text/x-handlebars-template">
        ...
        <div class="table-wrapper">
            <table class="table-look tablesaw tablesaw-swipe tablesaw-fix-persist" id="{{tableId}}" data-tablesaw-mode="swipe">
                <thead>
                <tr>
                    <th class="left tablesaw-cell-persist" scope="col" data-tablesaw-sortable-col="" data-tablesaw-sortable-default-col="" data-tablesaw-priority="persist">{{tableName}}
                    </th>
...
<script src="includes_keyfigures/js/jquery.mCustomScrollbar.concat.min.js"></script>
