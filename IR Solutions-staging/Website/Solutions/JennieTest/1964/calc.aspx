...
<script id="IRCalcTemplate" type="text/x-handlebars-template">
    ...
    <form id="calc-form">
        <div class="input-row">
            <label for="from-datepicker" class="input-label from-label" style="float: left;">{{t_calc_from}}:</label>
        ...
        <div class="input-row">
            <label for="to-datepicker" class="input-label to-label">{{t_calc_to}}: </label>
            <div class="input-wrapper">
                {{{datepicker 'to'}}}
                {{{selectToDay}}}
                {{{selectToMonth}}}
