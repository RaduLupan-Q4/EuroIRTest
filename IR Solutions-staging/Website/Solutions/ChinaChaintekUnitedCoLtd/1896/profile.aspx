...
<% 
    ...
    site.appendCustomCSSURL = "http://www.investorcom.co.uk/SharePriceChart/ChinaChainTek.css";
...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <div class="profile-wrapper">
        ...
        <b>Sector:</b> Industrial Transportation<br>
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Industrial Transportation</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">B80Z2L5</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">KYG2115W1006</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data country">Cayman Islands</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data date-listed">8/20/2012</td>
                    </tr>
                </table>
            </div>
