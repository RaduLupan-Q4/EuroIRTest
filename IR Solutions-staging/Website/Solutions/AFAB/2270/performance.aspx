    ...
    <table class="IRPerformanceModule table-look horizontal responsive">
        {{#headers}}
            <tr>
                ...
                <th class="Header column-last price">{{t_price}}</th>
                <th class="Header column-last months1">{{t_1_month}}</th>
                <th class="Header column-last months3">{{t_3_months}}</th>
                <th class="Header column-last months6">{{t_6_months}}</th>
