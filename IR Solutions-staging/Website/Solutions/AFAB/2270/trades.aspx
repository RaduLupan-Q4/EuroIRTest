    ...
    <table class="IRTradesModule table-look horizontal responsive" id="scroll-table">
        <thead>
            <tr>
                ...
                <th class="Header price">{{headers/t_price}} (SEK)</th>
                <th class="Header changePercentage">{{headers/t_change}} (%)</th>
                <th class="Header change">{{headers/t_change}} (SEK)</th>
        ...
        <tbody style="width: 100%;">
            ...
            <tr>
                ...
                <td class="Data changePercentage formatColour">{{showTradeChangePercentage tradePrice}} %</td>
                <td class="Data change formatColour">{{showTradeChange tradePrice}}</td>
