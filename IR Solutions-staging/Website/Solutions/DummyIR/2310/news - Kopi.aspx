...
<script type="text/javascript">
    ...
    setTimeout(function () {
        ...
        //$('.newsAttachments .hasAttachments .close_box').on('click', function () {
            $('.close_box').click(function () {
            //$('.select_inner').hide();
            $('.newsAttachments .select_inner').hide();
            $('.select_wrapper ul').addClass('iconPDF');
            //$('.newsAttachments .hasAttachments').removeClass('select_inner');
        });
    }, 1200);

</script>
<link rel="stylesheet" href="news.css?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("inc/emailAlerts.css")).Ticks.ToString()%>" />
