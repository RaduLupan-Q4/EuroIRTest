...
<% 
    ...
    string titleReleasesA = "Company announcements";
    string titleReleasesA1 = "Company announcements (English)";
    string titleReleasesA2 = "Company announcements (Danish)";
...
<head>
    ...
    <link rel="stylesheet" href="inc/emailAlertsWD.css?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("inc/emailAlertsWD.css")).Ticks.ToString()%>" />
</head>
<body>
                ...
                <div class="blockOuter indent">
                    <label>
                        <span class="checkboxOuter">
                            <input tabindex="7" type="checkbox" class="checkboxRelease ReleasesA1" id="ReleasesA1" />
                        </span>
                        <span class="checkBoxText"><%= titleReleasesA1 %>
                        </span>
                    </label>
                    <br />
                    <label>
                        <span class="checkboxOuter">
                            <input tabindex="7" type="checkbox" class="checkboxRelease ReleasesA2" id="ReleasesA2" />
                        </span>
                        <span class="checkBoxText"><%= titleReleasesA2 %>
                        </span>
                    </label>
...
If you would like to unsubscribe, please login and press the <strong>Unsubscribe</strong> button.</p><br/>
            ...
            %>
               ...
               <input type="hidden" name="activeClient" class="activeClient" value="William Demant A/S" />
                <input type="hidden" name="solutionID" class="solutionID" value="2412" />
                <input type="hidden" name="instrumentID" class="instrumentID" value="205058" />
