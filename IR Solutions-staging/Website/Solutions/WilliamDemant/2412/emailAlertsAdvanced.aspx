...
<% 
    // Settings
    string activeClient = "WilliamDemant";
    int solutionID = 2412;
    int instrumentID = 205058;
    int newsSourceID = 4;
...
<head>
    ...
    <link rel="stylesheet" href="inc/emailAlertsAdvanced.css?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("inc/emailAlertsAdvanced.css")).Ticks.ToString()%>" />
</head>
<body style="padding: 10px;">
    ...
    <div class="content">
        ...
        <div class="pageRegister">
            ...
            <form action="emailAlerts.aspx">
                ...
                <div class="blockOuter">
                    <div class="blockInner">
                        <div class="filter-box group">
                            <h2 class="header">Email Alerts</h2>
                            <div class="blockInner" style="margin-bottom: 20px;">
                            ...
                            <div class="pressReleases" style="margin-bottom: 20px;">
                                <div class="subGroup">
                                    <h2 class="header">Company announcements</h2>
                                    <label>
                                        <%--<input type="checkbox" class="checkbox checkboxRegulatory" name="emailEOD" id="ReleasesATrigger" />General Releases--%>
                                        <input type="checkbox" class="checkboxRelease" name="emailEOD" id="ReleasesA" />General Releases
                                    </label>
                            ...
                            <div class="email-alert-subscription__box" id="eas6-box">
                                <div>
                                    <label class="forms__checkbox--label" for="eas6">
                                        <p style="min-width: 130px; float: left;">Low:</p>
                                ...
                                <div>
                                    <label class="forms__checkbox--label" for="eas6">
                                        <p style="min-width: 130px; float: left;">High:</p>
                ...
                <div class="email-alert-subscription__box--last">
                    <button type="submit" id="eas-submit" class="formRegister button button--secondary">Submit</button>
                    <p class="unsubscribeLink"><a href="javascript:void(0)" class="email-alert-subscription__email cleanLink formUnsubscribe unsubscribeNextToButton">Unsubscribe</a></p>
                </div>
            </form>
            <div style="clear: both;"></div>
        </div>
        ...
        <div class="pageUnsubscribe">
            ...
            <form action="emailalerts.aspx">
                ...
                <input type="hidden" name="newsSourceID" class="newsSourceID" value="<%= newsSourceID %>" />
    ...
    <script type="text/javascript" src="checkbox.js?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("checkbox.js")).Ticks.ToString()%>"></script>
</body>
</html>
