...
<script id="IRMiniquoteChartModuleTemplate" type="text/x-handlebars-template">
        ...
        <div class="stockQuote table-wrapper">
            ...
            <%--<button type="submit" class="submit" onclick="parent.document.location.href='http://www.demant.com/investor-relations/share-information/'">Stock Chart</button>--%>
            <a href="http://www.demant.com/investor-relations/share-information/" target="_parent" class="link btn">Read More</a>
        </div>
    </script>
