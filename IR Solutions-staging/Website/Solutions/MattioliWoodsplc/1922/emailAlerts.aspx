...
<!--    <link rel="stylesheet" type="text/css" media="screen" href="ir.client.css" />-->
    ...
    <link rel="stylesheet" href="emailAlerts.css?v=63613261834066225312" />
                ...
                <div class="blockOuter">
                    ...
                    <div class="blockInner">
                       <div class="inputTextTitle">
                        ...
                        <div class="inputText">
                            <input tabindex="2" class="informationInput enterInformationEmail" name="enterInformationEmail" type="text" value="" placeholder="Enter Your E-Mail Address *" id="enterInformationEmail" />
                        </div>
                    </div>
                    ...
                    <div class="blockInner">
                       <div class="inputTextTitle">
                        ...
                        <div class="inputText">
                            <input tabindex="1" class="informationInput enterInformationFirstName" name="enterInformationFirstName" type="text" value="" placeholder="Enter Your First Name *" id="enterInformationFirstName" />
                        </div>
                    </div>
                    ...
                    <div class="blockInner">
                       <div class="inputTextTitle">
                        ...
                        <div class="inputText">
                            <input tabindex="1" class="informationInput enterInformationFirstName" name="enterInformationFirstName" type="text" value="" placeholder="Enter Your Surname *" id="enterInformationFirstName" />
                        </div>
                    </div>
                    ...
                    <div class="blockInner">
                       <div class="inputTextTitle">
                        ...
                        <div class="inputText">
                            <input tabindex="1" class="informationInput enterInformationFirstName" name="enterInformationFirstName" type="text" value="" placeholder="Enter Your Company" id="enterInformationFirstName" />
                        </div>
                    </div>
                    ...
                    <div class="blockInner">
                       <div class="inputTextTitle">
                        ...
                        <div class="inputText">
                            <input tabindex="1" class="informationInput enterInformationFirstName" name="enterInformationFirstName" type="text" value="" placeholder="Enter Your Country" id="enterInformationFirstName" />
                        </div>
                    </div>
                ...
                <div class="blockNoBorder max-width-600">
                    ...
                    <div class="blockInner">
                       <div class="inputTextTitle">
                        ...
                        <div class="inputText">
                            <input tabindex="1" class="inputTextField unsubscribeEmail" name="unsubscribeEmail" type="text" value="" placeholder="Enter Your Email Address" />
                        </div>
                    </div>
