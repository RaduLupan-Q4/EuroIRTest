...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <div class="profile-wrapper">
        ...
        <div class="miniquoteModule">
            <b>Sector: </b>Support Services<br>
            <b>{{headers/t_share}} {{headers/t_price}}: </b> {{decimals stocks/last}}p<br>
            <b>{{headers/t_change}} {{headers/t_today}}: </b><span class="{{formatColour stocks/change}}">{{decimals stocks/change}}</span><span class="{{showArrow stocks/change}}"></span>
            <br>
            <b>{{headers/t_market_cap}}: </b> &pound;{{showLondonMarketCapM stocks/marketCap}}m<br>
        </div>
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Support Services</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">BD37ZH0</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">GB00BD37ZH08</td>
                    </tr>
                    <tr>
                        <td class="Header market-sector">Market Sector</td>
                        <td class="Data market-sector">Industrials</td>
                    </tr>
                    <tr>
                        <td class="Header market-segment">Market Segment</td>
                        <td class="Data market-segment">AIM</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data currency">British Pounds</td>
                    </tr>
                    <tr>
                        <td class="Header nms">NMS</td>
                        <td class="Data nms">15000</td>
                    </tr>
                    <tr>
                        <td class="Header date-listed">Date Listed</td>
                        <td class="Data date-listed">22/08/2016</td>
                    </tr>
                </table>
            </div>
