...
<div class="wrapper1">
	<div class="announcementsHeader">
		<span class="t_archived_events"></span>
					...
					<div class="headlineWrapper">
						<div class="calendarDate">
							<div class="publishDateWrapper">
								...
								<div class="date">{{eventTime keyValueSet}}</div>
...
<script type="text/javascript">
	...
	$(function () {
		...
		$.getJSON(getServiceEngingeURL() + 'RequestNewsCalendarPagination?apiversion=1&lcid='+clientLCID+'&customerKey=RevenioGroup&solutionID=2546&MaxRows=100&pageno=0&instrumentid=1000758&StartDate=2013-04-01' + '&EndDate=' + convertedDate + '&sortAscDesc=desc', function (data) {
			...
			$.when(requestTranslationsData).done(function() {
				...
				$('.t_archived_events').html(translationData.data.t_archived_events);
	...
	function formatDateWithFormat(timestamp, format) {
	    ...
	    var dateWithFormat = new moment(timestamp, globalActiveExchangeTimeZone).add(clientStyle.manualTimeOffset, 'hours').format(format);
