...
<script id="IRCalcTemplate" type="text/x-handlebars-template">
    ...
    <div id="container" class="tabs">
        <ul class="tabsWrapper">
            <li class="tabitem tab-1"><a href="//ir.euroinvestor.com/Solutions/GoodmanGroup/2544/chart_secure.aspx" target="_self">Security price information |</a></li>
            ...
            <li class="tabitem tab-3"><a class="current" href="//ir.euroinvestor.com/Solutions/GoodmanGroup/2544/calc_secure.aspx" target="_self">Investment calculator</a></li>
        </ul>
    </div>
</div>
