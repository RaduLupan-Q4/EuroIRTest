     ...
     <table class="IRQuoteModule table-look horizontal responsive">
        ...
        {{#stocks}}
            <tr>
                ...
                <td class="Data change {{formatColour stocks/change}}">{{decimals change}} ({{decimals changePercent}}%) <span class="{{showArrow stocks/change}}"></span></td>
       ...
       <%--         <td class="Data bid">{{decimals bid}}</td>
                ...
                <td class="Data volume">GBP {{showLondonMarketCapM marketCap}}M</td>
                <%--<td class="Data volume">{{decimals stocks/shareMillions}}</td>--%>
