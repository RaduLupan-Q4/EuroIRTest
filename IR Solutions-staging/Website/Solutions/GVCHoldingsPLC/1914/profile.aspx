...
<% 
    ...
    site.appendCustomCSSURL = "//www.investorcom.co.uk/SharePriceChart/GVCHoldings.css";
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Travel & Leisure</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">B5VQMV6</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">IM00B5VQMV65</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data market-segment">SSMU</td>
                    </tr>
                    <tr>
                        <td class="Header country">Country of register</td>
                        <td class="Data country">Isle of Man</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data nms">3000</td>
                    </tr>
                    <tr>
                        <td class="Header date-listed">Date Listed</td>
                        <td class="Data date-listed">3/20/2013</td>
                    </tr>
                </table>
            </div>
