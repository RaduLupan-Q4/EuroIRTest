...
<div class="register-wrapper">
	...
	<div class="register-box">
		<div class="inputLabel">{{headers/t_email_address}}</div><input class="register_emailAddress" type="text" />
	</div>
	<div class="register-box">
	...
	<div class="alertType-box">
		...
		<div class="alertType-subbox">
			<label for="alertType_allNewsTypes" class="alertTypeLabel alertTypeSubCheckboxAll">{{headers/t_all_news_types}}</label>
				<label class="alertTypeLabel alertTypeSubLabel"><input class="alertTypeSubCheckbox alertType_ alertType_1" type="checkbox" />{{headers/t_material_events}}</label>
				<label class="alertTypeLabel alertTypeSubLabel"><input class="alertTypeSubCheckbox alertType_ alertType_2" type="checkbox" />{{headers/t_holdings_of_principal_shareholders}}</label>
				<label class="alertTypeLabel alertTypeSubLabel"><input class="alertTypeSubCheckbox alertType_ alertType_3" type="checkbox" />{{headers/t_quarterly_and_annual_financial_reports}}</label>
				<label class="alertTypeLabel alertTypeSubLabel"><input class="alertTypeSubCheckbox alertType_ alertType_4" type="checkbox" />{{headers/t_prospectuses_and_shelf_offer_reports}}</label>
				<label class="alertTypeLabel alertTypeSubLabel"><input class="alertTypeSubCheckbox alertType_ alertType_5" type="checkbox" />{{headers/t_general_meetings}}</label>
				<label class="alertTypeLabel alertTypeSubLabel"><input class="alertTypeSubCheckbox alertType_ alertType_6" type="checkbox" />{{headers/t_corporate_officers}}</label>
				<label class="alertTypeLabel alertTypeSubLabel"><input class="alertTypeSubCheckbox alertType_ alertType_7" type="checkbox" />{{headers/t_miscellaneous}}</label>
		</div>
	</div>
