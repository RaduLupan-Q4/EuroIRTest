...
<% 
    // Settings
    string activeClient = "Delek Drilling";
    int solutionID = 2098;
    int instrumentID = 1793250;
    ...
    string titleReleasesD = "Quote By Email";
    string titleReleasesE = "Weekly Stock Summary";
    string titleReleasesF = "Stock Threshold Alert";
    string titleReleasesG = "Percent Change Alert";
    string titleReleasesH = "All news releases";
    string titleReleasesI = "Company announcements";
    string titleReleasesJ = "Press releases";
    string titleReleasesK = "Additional information about us, our products and services which may be of interest to you.";
...
<head>
    ...
    <link rel="stylesheet" href="ir.client.css" />
    <link rel="stylesheet" href="inc/emailAlerts_dummy.css?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("inc/emailAlerts_dummy.css")).Ticks.ToString()%>" />
            ...
            <form action="emailAlerts.aspx">
                ...
                <div class="alert-wrapper">
                    ...
                    <div class="blockOuter">
                        ...
                        <label>
                            <span class="checkboxOuter">
                                <input tabindex="8" type="checkbox" class="checkboxRelease ReleasesD" id="ReleasesD" />
                            </span>
                            <span class="checkBoxText"><%= titleReleasesD %>
                            </span>
                        </label>
                        <p style="margin-bottom: 15px;">
                            Send me a stock update at the end of the trading day.
                        </p>

                        <label>
                            <span class="checkboxOuter">
                                <input tabindex="8" type="checkbox" class="checkboxRelease ReleasesE" id="ReleasesE" />
                            </span>
                            <span class="checkBoxText"><%= titleReleasesE %>
                            </span>
                        </label>
                        <p style="margin-bottom: 15px;">
                        ...
                        <label>
                            <span class="checkboxOuter">
                                <input tabindex="8" type="checkbox" class="checkboxRelease ReleasesF" id="ReleasesF" />
                            </span>
                            <span class="checkBoxText"><%= titleReleasesF %>
                            </span>
                        </label>
                        <p>
                            Alert me when the stock crosses the following price thresholds.
                            <br>
                            Current Stock Price is 346,40 DKK
                        </p>
                        <div class="inputRowLow">
                            <p class="inputTextLow">Low: </p>
                            <div class="inputHighLow">
                                <input class="inputBoxLow" type="text" />
                                <span class="inputBoxHighLowCurrency">ILS</span>
                            </div>
                        </div>
                        <div class="inputRowHigh">
                            <p class="inputTextHigh">High: </p>
                            <div class="inputHighLow">
                                <input class="inputBoxHigh" type="text" />
                                <span class="inputBoxHighLowCurrency">ILS</span>
                            </div>
                        </div>
                        ...
                        <label>
                            <span class="checkboxOuter">
                                <input tabindex="8" type="checkbox" class="checkboxRelease ReleasesG" id="ReleasesG" />
                            </span>
                            <span class="checkBoxText"><%= titleReleasesG %>
                            </span>
                        </label>
                        <p style="margin-bottom: 15px;">
                            Alert me when the stock changes more than  
                    ...
                    <div class="blockOuter">
                        <label>
                            <span class="checkboxOuter">
                                <input tabindex="8" type="checkbox" class="checkboxRelease ReleasesH" id="ReleasesH" />
                            </span>
                            <span class="checkBoxText"><%= titleReleasesH %>
                            </span>
                        </label>
                        <br />
                        <label>
                            <span class="checkboxOuter indent">
                                <input tabindex="8" type="checkbox" class="checkboxRelease ReleasesI" id="ReleasesI" />
                            </span>
                            <span class="checkBoxText"><%= titleReleasesI %>
                            </span>
                        </label>
                        <br />
                        <label>
                            <span class="checkboxOuter indent">
                                <input tabindex="8" type="checkbox" class="checkboxRelease ReleasesJ" id="ReleasesJ" />
                            </span>
                            <span class="checkBoxText"><%= titleReleasesJ %>
                            </span>
                        </label>
                        <br />
                        <label>
                            <span class="checkboxOuter indent">
                                <input tabindex="8" type="checkbox" class="checkboxRelease ReleasesK" id="ReleasesK" />
                            </span>
                            <span class="checkBoxText"><%= titleReleasesK %>
                            </span>
                        </label>

                        <div class="divider"></div>

                        <span>Recieve releases in</span>
                        <br />
                        <span class="checkboxOuter">
                            <input type="radio" checked="checked" name="companyAnnoucementLanguage" value="English" class="companyAnnoucementLanguage" id="Radio1">
                            English
                        </span>
                        <label>
                        <span class="checkboxOuter">&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="companyAnnoucementLanguage" value="Danish" class="companyAnnoucementLanguage" id="Radio2">
                            Danish
                        </span>
                    </label>
