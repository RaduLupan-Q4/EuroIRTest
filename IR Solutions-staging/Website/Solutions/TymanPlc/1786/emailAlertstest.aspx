...
<%     
    // Settings
    string activeClient = "TymanPlc";
    int solutionID = 1786;
    int instrumentID = 13818281;
...
<head>
    ...
    <!-- <link rel="stylesheet" href="http://fonts.googleapis.com/css?family=Roboto:400,100,100italic,300,300italic,400italic,500,500italic,700,700italic,900,900italic" type="text/css" /> -->
	<link rel="stylesheet" href="//f.fontdeck.com/s/css/Gaw5TxJDiiEMYaqF8iLcIrFbPac/ir.euroinvestor.com/59507.css" type="text/css" />
	
    <link rel="stylesheet" href="ir.client.css?v=<%= System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("ir.style.css")).Ticks.ToString() %>" type="text/css" />
</head>
<body style="font-size: 16px; overflow: hidden">
    <div class="" style="font-family:'FS Albert Web Regular', sans-serif;">test test jeg tester</div>
    <div class="" style="font-family:sans-serif;">test test jeg tester</div>
    <div class="content">
