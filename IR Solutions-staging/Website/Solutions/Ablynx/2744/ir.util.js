...
var IRChartTSRfeature = {
    ...
    updateInterval: function () {
        if (this.dividendSimpleReal.length > 0) {
            ...
            this.dividendSimpleData = simpleData;
        ...
        if (this.dividendReinvestReal.length > 0) {
            ...
            this.dividendReinvestData = reinvestData;
...
function getTooltipStrSubHistorical(dateIndex) {
    ...
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideOpen) {
        ...
        // if (typeof (globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex]) != 'undefined') {
        tooltipStr += "<div class=\"IRChartTooltipOpen\"><span class=\"subHeader\">" + getOHLCfromTranslations('o') + "</span><span class=\"subShadow\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][1]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][1]) + "</span></div>";
        //}
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideHigh) {
        ...
        // if (typeof (globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex]) != 'undefined') {
        tooltipStr += "<div class=\"IRChartTooltipHigh\"><span class=\"subHeader\">" + getOHLCfromTranslations('h') + "</span><span class=\"subShadow\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][2]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][2]) + "</span></div>";
        //}
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideLow) {
        ...
        //if (typeof (globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex]) != 'undefined') {
        tooltipStr += "<div class=\"IRChartTooltipLow\"><span class=\"subHeader\">" + getOHLCfromTranslations('l') + "</span><span class=\"subShadow\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][3]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][3]) + "</span></div>";
        //}
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideClose) {
        ...
        //if (typeof (globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex]) != 'undefined') {
        tooltipStr += "<div class=\"IRChartTooltipClose\"><span class=\"subHeader\">" + getOHLCfromTranslations('c') + "</span><span class=\"subShadow\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][4]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][4]) + "</span></div>";
        //}
    ...
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideVolume) {
        ...
        //if (typeof (globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex]) != 'undefined') {
        tooltipStr += "<div class=\"IRChartTooltipVolume\"><span class=\"subHeader\">" + getOHLCfromTranslations('v') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][5]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][5]) + "</span></div>";
        // }
...
function getTooltipStrSubIntraday(dateIndex) {
    ...
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideOpen) {
        ...
        tooltipStr += "<div class=\"IRChartTooltipOpen\"><span class=\"subHeader\">" + getOHLCfromTranslations('o') + "</span><span class=\"subShadow\">" + formatDecimal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][1]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][1]) + "</span></div>";
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideHigh) {
    }
    else {
        tooltipStr += "<div class=\"IRChartTooltipHigh\"><span class=\"subHeader\">" + getOHLCfromTranslations('h') + "</span><span class=\"subShadow\">" + formatDecimal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][2]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][2]) + "</span></div>";
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideLow) {
    }
    else {
        tooltipStr += "<div class=\"IRChartTooltipLow\"><span class=\"subHeader\">" + getOHLCfromTranslations('l') + "</span><span class=\"subShadow\">" + formatDecimal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][3]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][3]) + "</span></div>";
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideClose) {
    }
    else {
        tooltipStr += "<div class=\"IRChartTooltipClose\"><span class=\"subHeader\">" + getOHLCfromTranslations('c') + "</span><span class=\"subShadow\">" + formatDecimal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][4]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][4]) + "</span></div>";
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideVolume) {
    }
    else {
        tooltipStr += "<div class=\"IRChartTooltipVolume\"><span class=\"subHeader\">" + getOHLCfromTranslations('v') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][5]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][5]) + "</span></div>";
    }
    return tooltipStr;
}
...
function getTooltipStrSubTSR(dateIndex) {
    ...
    if (chartFeatureMode == chartDisplayModes.intraday) {
        ...
        tooltipStr += "<div class=\"IRChartTooltipClose\"><span class=\"subHeader\">" + getOHLCfromTranslations('c') + "</span><span class=\"subShadow\">" + formatDecimal(globalChartListingStockData[globalActiveListingIndex][dateIndex][1]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingStockData[globalActiveListingIndex][dateIndex][1]) + "</span></div>";
        tooltipStr += "<div class=\"IRChartTooltipVolume\"><span class=\"subHeader\">" + getOHLCfromTranslations('v') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][5]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][5]) + "</span></div>";
        tooltipStr += "<div class='tooltipSep'></div>";

        for (var i = 0; i < IRChartTSRfeature.activeTSR.length; i++) {
            tooltipStr += "<div><span class=\"subHeader\"><span class=\"colorIndicator color" + globalChartColours[i + 1].replace('#', '') + " active\"></span>" + IRChartTSRfeature.activeTSR[i].replace("Data", "").replace("dividend", "") + ": </span><span class=\"subShadow\">" + formatDecimal(IRChartTSRfeature[IRChartTSRfeature.activeTSR[i]][dateIndex][1]) + "</span><span class=\"subContent\">" + formatDecimal(IRChartTSRfeature[IRChartTSRfeature.activeTSR[i]][dateIndex][1]) + "</span></div>";
        }
    }
        ...
        if (!chartEnabledClickHandlers.chartNavigationTA) {
            ...
            if (typeof ($('.IRChartTA #IRChartNavigationClearTA')) == 'object') {
                $('.IRChartTABodyList .basicButtonLook').click(function () {
                    if ($(this).not('#IRChartNavigationClearTA')) {
                        ...
                        if ($(this).hasClass('active')) {
                            ...
                            var inp = $(this).find('.inputBox .period-list');
                            inp.val(Number(inp.data('min')));
                            $(this).find('.inputBox').slideDown(300);
                            $(this).addClass('pop');
                        }
                    }
                });
                $('.IRChartNavigation .IRChartTA .inputBox .period-list').on('click', function (event) {
                ...
                $(document).on('click', '.IRChartNavigation .IRChartTA .inputBox .pop-submit', function (event) {
                    ...
                    var period = popDom.find('.period-list').val();
...
function updateTooltipComparisonDC(date) {
    ...
    try {
        dateIndex = globalChartListingStockDataDates[globalActiveListingIndex].indexOf(date);
        tooltipStr += "<div>" + new moment(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][0]).format(clientStyle.formatDate) + "</div>";
        tooltipStr += "<div><span class=\"subHeader\"><span class=\"colorIndicator active\" style=\"border-left-color: " + globalChartColours[0] + ";\"></span>" + globalRawStockData[globalActiveListingIndex].symbol + ": </span><span class=\"subShadow\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][1]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][1]) + "</span></div>";
        for (var i = 0; i < globalChartComparisonData[0].length; i++) {

            if (globalChartComparisonInChart[i + 1] == 1) {
                tooltipStr += "<div><span class=\"subHeader\"><span class=\"colorIndicator color" + globalChartColours[i + 1].replace('#', '') + " active\"></span>" + globalChartComparisonSymbols[i] + ": </span> <span class=\"subShadow\">" + formatDecimal(globalChartComparisonData[0][i][dateIndex][1]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartComparisonData[0][i][dateIndex][1]) + "</span></div>";
            }
        }
    }
    catch (err) {
        var newDateIndex = getClosestDateIndexForListingClosePrice(date);
        tooltipStr += "<div>" + new moment(globalChartListingStockDataOHLCV[globalActiveListingIndex][newDateIndex][0]).format(clientStyle.formatDate) + "</div>";
        tooltipStr += "<div><span class=\"subHeader\"><span class=\"colorIndicator active\" style=\"border-left-color: " + globalChartColours[0] + ";\"></span>" + globalRawStockData[globalActiveListingIndex].symbol + ": </span><span class=\"subShadow\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][newDateIndex][1]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][newDateIndex][1]) + "</span></div>";
        for (var i = 0; i < globalChartComparisonData[0].length; i++) {
            if (globalChartComparisonInChart[i + 1] == 1) {
                tooltipStr += "<div><span class=\"subHeader\"><span class=\"colorIndicator color" + globalChartColours[i + 1].replace('#', '') + " active\"></span>" + globalChartComparisonSymbols[i] + ": </span><span class=\"subShadow\">" + formatDecimal(globalChartComparisonData[0][i][newDateIndex][1]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartComparisonData[0][i][newDateIndex][1]) + "</span></div>";
            }
        }
    }
    tooltipStr += "</div>";
    ...
    switch (chartFeatureMode) {
        ...
        case chartDisplayModes.historical:
            try {
                dateIndex = globalChartListingStockDataDates[globalActiveListingIndex].indexOf(date);
                tooltipStr += "<div>" + new moment(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][0]).format(clientStyle.formatDate) + "</div>";
                tooltipStr += "<div><span class=\"subHeader\">" + getOHLCfromTranslations('c') + "</span><span class=\"subShadow\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][4]) + "</span><span class=\"subContent\">" + formatDecimal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][4]) + "</span></div>";
            ...
            try {
                for (var i = 0; i < activeTA.length; i++) {
                    ...
                    tooltipStr += "<div><span class=\"subHeader\"><span class=\"colorIndicator color" + activeTAcolor[i].replace('#', '') + " active\"></span>" + activeTA[i] + ": </span><span class=\"subShadow\">" + formatDecimal(activeTAlist[j][dateIndex][1]) + "</span><span class=\"subContent\">" + formatDecimal(activeTAlist[i][dateIndex][1]) + "</span></div>";
                }
            }
            catch (err) {
                dateIndex = getClosestDateIndexForListingClosePrice(date);
                for (var j = 0; j < activeTA.length; j++) {
                    tooltipStr += "<div><span class=\"subHeader\"><span class=\"colorIndicator color" + activeTAcolor[j].replace('#', '') + " active\"></span>" + activeTA[j] + ": </span><span class=\"subShadow\">" + formatDecimal(activeTAlist[j][dateIndex][1]) + "</span><span class=\"subContent\">" + formatDecimal(activeTAlist[j][dateIndex][1]) + "</span></div>";
                }
            }
            break;
    }
...
function updateTechnicalAnalysis(id, color, period) {
    ...
    switch (id) {
        case "CommodityChannelIndex":
            loadAnalysisCommodityChannelIndex(clientStyle.amountOfHistoricalYears, period);
            applyAnalysis("CCI", color, period);
            break;

        case "DirectionalMovementIndex":
            loadAnalysisDirectionalMovementIndex(clientStyle.amountOfHistoricalYears, period);
            applyAnalysis("DMI", color, period);
            break;

        case "ExponentialMovingAverage":
            loadAnalysisExponentialMovingAverage(clientStyle.amountOfHistoricalYears, period);
            applyAnalysis("EMA", color, period);
            break;

        case "Momentum":
            loadAnalysisMomentum(clientStyle.amountOfHistoricalYears, period);
            applyAnalysis("Mom", color, period);
            break;

        case "MoneyFlowIndex":
            loadAnalysisMoneyFlowIndex(clientStyle.amountOfHistoricalYears, period);
            applyAnalysis("MFI", color, period);
            break;

        case "RateOfChange":
            loadAnalysisRateOfChange(clientStyle.amountOfHistoricalYears, period);
            applyAnalysis("RoC", color, period);
            break;

        case "RelativeStrengthIndex":
            loadAnalysisRelativeStrengthIndex(clientStyle.amountOfHistoricalYears, period);
        ...
        case "WilliamsPercentR":
            loadAnalysisWilliamsPercentR(clientStyle.amountOfHistoricalYears, period);
