...
<% 
    // Settings
    string activeClient = "AppliedGrapheneMaterials";
    int solutionID = 2152;
    int instrumentID = 17873974;
        ...
        <div class="subPageLogin">
            ...
            <form action="emailAlerts.aspx">
                ...
                <div class="input-wrapper">
                    ...
                    <div class="emptyEmailNotificationMessage" style="display: none; color: red; font-weight: bold; width: 100%;
    float: left; ">Email input field can not be left blank.</div>              
                </div>
            </form>
