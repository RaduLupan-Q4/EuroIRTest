...
<script type="text/javascript">
    ...
    console.log(IRNewsPaginationActivePage);
    ...
    function prepareCustomX() {
        ...
        $('.IRNewsPaginationPageNew.IRNewsPaginationPageNext').css('display', 'none');
    }else{
        $('.IRNewsPaginationPageNew.IRNewsPaginationPageNext').css('display', 'inline-block');
    }
    }
