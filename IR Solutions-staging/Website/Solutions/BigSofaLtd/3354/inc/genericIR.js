...
function retrieveAndPostValues()
{
    ...
    $.ajax({
        ...
        data: {
            ...
            enterInformationProfession: $('#enterInformationProfession').val(),
            ...
            ReleaseRSS: $('#ReleaseRSS, #ReleaseRSSTrigger').attr('checked'),
...
function checkInputFields()
{
    ...
    if (!isOK) {
        ...
        $('.requiredFieldMSG').html('<spand class="requiredFieldMSGStyle">This field is required.</span>');
...
function checkReturnValues(data)
{
    ...
    if (data.msgToReturn != "") {
        ...
        if (data.msgToReturn == "UserCreated") {
            header = 'Verification';
            paragraph = 'Almost finished... We need to confirm your email address. To complete the subscript process, please click the link in the email we just sent you.';
