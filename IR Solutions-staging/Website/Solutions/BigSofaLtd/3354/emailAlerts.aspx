...
<% 
    // Settings
    string activeClient = "BigSofaLtd";
    int solutionID = 3354;
    int instrumentID = 263845;
...
<body>
    ...
    <div class="content">
        ...
        <div class="pageRegister" >
            ...
            <%--<h2 class="header">IR e-mail alerts</h2>--%>
            <p>
                Register for out email alert service and keep up to date on 
                all of Big Sofa Technologies' regulatory news announcements. 
            </p>
            ...
            <form action="emailAlerts.aspx">
                ...
                <div class="blockOuter">
                    ...
                    <div class="blockInner">
                        ...
                        <div class="inputText">
                            <input tabindex="2" class="informationInput enterInformationEmail" name="enterInformationEmail" type="text" value="" id="enterInformationEmail" placeholder="Subscribe with email for alerts" />
                            <input type="button" tabindex="9" class="formRegister buttonStyle clearInput" style="float: right;position: absolute; width: 15%;" value="" />
            ...
            <%--    <div class="blockNoBorder">
                    <input type="button" tabindex="9" class="formRegister buttonStyle clearInput" style="float: left" value=">" />
    ...
    <script src="inc/genericIR.js?posad"></script>
