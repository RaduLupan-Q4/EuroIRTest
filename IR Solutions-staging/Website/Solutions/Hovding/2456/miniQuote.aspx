...
<script id="IRMiniquoteModuleTemplate" type="text/x-handlebars-template">
    <div class="IRMiniquoteModuleWrapper">
        <table class="IRMiniQuoteQuoteModule table-look responsive">
            ...
            <tr>
                <th class="Data last">{{decimals stocks/last}} </th>
                <td class="currency">{{stocks/currency}}</td>
            </tr>
            <tr>
                <th class="Header change">{{headers/t_change}}</th>
                <td class="Data">{{decimals stocks/change}} ({{decimals stocks/changePercent}} %) <span class="{{showArrow stocks/change}}"></span></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="Data delayed">First North, Stockholm</td>
            </tr>
        </table>
