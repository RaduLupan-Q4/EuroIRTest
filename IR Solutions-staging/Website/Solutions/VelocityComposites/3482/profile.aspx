            ...
            <div class="company-listing-data">
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">{{stocks/exchangeName}}</td>
                    </tr>
                    <tr>
                          <td class="Header market-cap">{{headers/t_currency}}</td>
                          <td class="Data market-cap">{{stocks/currency}}</td>
                    </tr>
                    <tr>
                        <td class="Header country">{{headers/t_minimum_trade}}</td>
