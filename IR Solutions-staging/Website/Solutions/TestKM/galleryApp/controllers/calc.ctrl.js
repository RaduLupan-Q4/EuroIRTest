galleryApp.controller('calcController', ['$scope', '$sce', '$rootScope', '$timeout', 'generator', function ($scope, $sce, $rootScope, $timeout, generator) {
    $rootScope.msg = "Calc";
    const pageId = 'calc';
    ...
    let iframeSrc = 'solutionModules/calc.html';
