                ...
                $('.IRChartTABodyList .basicButtonLook').click(function () {
                    if ($(this).not('#IRChartNavigationClearTA')) {
                        ...
                        if ($(this).hasClass('active')) {
                            removeThisTechnicalAnalysis($(this).attr('id'));
                            ...
                            updateTechnicalAnalysis($(this).attr('id'), colorId);
...
function updateTechnicalAnalysis(id, color) {
    ...
    switch (id) {
        ...
        case "SimpleMovingAverage":
            ...
            applyAnalysis("SimpleMovingAverage", "SMA", color);
            break;
...
function applyAnalysis(TAName, TAShort, color) {
...
function applyAnalysisToChart(dataTA, TAShort, color, TAtype) {
    stockDataTA.push([]);
    var TAArrayForChart = [];
    ...
    activeTAhtml += '<span>' + TAShort + '</span>';
    activeTAhtml += '</div>';
