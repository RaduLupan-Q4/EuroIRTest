...
function getSolutionID() {
    var solArr = window.location.hash.split("/");
    // solArr.reverse();
    return solArr[2];
}
   ...
   mainChart = {
       ...
       yAxis: [{
           ...
           labels: {
               ...
               y: 5,
               formatter: function () {
                   return NumberFormat.decimal1000Zeros(this.value) + '';
               }
           },
           title: {
               text: null
...
var IRdatepickers = {
    ...
    dateSelectChangeHandler: function () {
        ...
        var fromMonth = parseInt(scope.find(".from-month").val(), 10) + 1;
        var fromYear = parseInt(scope.find(".from-year").val(), 10);
        var fromDay = parseInt(scope.find(".from-day").val(), 10);
        var validFromDay = Math.min(IRdatepickers.getDaysInMonth(fromMonth, fromYear), fromDay);

        var toMonth = parseInt(scope.find(".to-month").val(), 10) + 1;
        var toYear = parseInt(scope.find(".to-year").val(), 10);
        var toDay = parseInt(scope.find(".to-day").val(), 10);
        var validToDay = Math.min(IRdatepickers.getDaysInMonth(toMonth, toYear), toDay);
...
var IRLookupModuleBuild = {
    initializeLookup: function (data) {
        ...
        if (getUriParam("mode") === "list") {
            ...
            $(".lookup-form, .lookup-table-form").on("submit", function (e) {
                e.preventDefault();
    ...
    calculateHistoricalValue: function () {
        ...
        $('.IRLookupModule .outputLookupValue').html(NumberFormat.decimal1000Zeros(priceAtFromDate));
    }
};
// Calc Module
