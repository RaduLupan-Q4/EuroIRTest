...
function initHandlebars() {
    ...
    compiledTemplates.menuTemplate_QuoteTableHorizontal = compileHtmlTemplate(ModulesList.IRQuoteHorizontalModule);
    compiledTemplates.menuTemplate_QuoteTableVertical = compileHtmlTemplate(ModulesList.IRQuoteVerticalModule);
