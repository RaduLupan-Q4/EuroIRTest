...
<script id="IRProfileTemplate" type="text/x-handlebars-template">
    ...
    <div class="profile-wrapper">
        ...
        <iframe id="calcProfileiFrame" src="http://ir.euroinvestor.com/solutionsstaging/FerrariExample/2442/miniquoteChartProfile.aspx" style="width: 100%; float: left; height: auto; margin-bottom: 40px; margin-top: 40px;"></iframe>
