        ...
        <ul class="list_reset ul-list-tabs">
            ...
            <li class="li-tab tab-3" id="tab3">
                <select id="select-filter2">
                    <option selected='selected' value='Title and Content' id='en'>English</option><option value='Title and Content' id='da'>Danish</option>
                                ...
                                <div class="select_wrapper">
                                    ...
                                    <div class="ul iconPDF">
                                        ...
                                        <div class="newsAttachmentBox">
                                            <div class="headerAttachment">Download</div>
                                            {{#each attachments}}      
