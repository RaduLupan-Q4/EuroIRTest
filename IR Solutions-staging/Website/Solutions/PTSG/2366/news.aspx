...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
    ...
    <script id="IRNewsTemplate" type="text/x-handlebars-template">
        ...
        <p style="display: none;">Information on this page is updated via a feed from the London Stock Exchange's Regulatory News Service. To retrieve the full story please click on the headline. Stories will open in a new tab.</p>
