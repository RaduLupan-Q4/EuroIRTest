...
<% 
    // Settings
    string activeClient = "Invesco";
    int solutionID = 2116;
    int instrumentID = 1765;
...
If you would like to unsubscribe, please login and press the <strong>Unsubscribe</strong> button.</p><br/>
                    ...
                    <div class="input-wrapper">
                        <input tabindex="1" class="informationInput enterInformationLoginEmail" type="text" name="enterInformationLoginEmail" type="email" value="" />
