...
<script id="IRQuoteTableHorizontalTemplate" type="text/x-handlebars-template">
    ...
    <div class="iframe-wrapper" style="height: 6308px;">
    <h3>Share Price Throughout the Day</h3>
        <div class="divideLine"></div>
    <iframe src="http://ir1.euroinvestor.com/asp/ir/MarketTechHoldings/detailedSharePrice.aspx" style="width: 100%; border: none; height: 6308px;"></iframe>
    </div>
