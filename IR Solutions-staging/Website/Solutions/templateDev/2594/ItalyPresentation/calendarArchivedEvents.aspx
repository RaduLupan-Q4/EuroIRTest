                    ...
                    <div class="headlineWrapper">
                        ...
                        <div class="CalendarContentWrapper">
                            <div class="calendarContent">
                                ...
                                <button class="showHideButton">+</button>
                                <span class="descriptionText">{{text}}</span>
                            </div>
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.getJSON('/ServiceEngine/api/json/reply/RequestNewsCalendarPagination?apiversion=1&lcid=1033&customerKey=WilliamDemant&solutionID=2412&MaxRows=100&pageno=0&instrumentid=1000589&StartDate=2013-04-01T08:51:48.990Z' + '&EndDate=' + convertedDate + '&sortAscDesc=desc', function (data) {
    ...
    function selectPeriod() {
        ...
        $.getJSON('/ServiceEngine/api/json/reply/RequestNewsCalendarPagination?apiversion=1&lcid=1033&customerKey=WilliamDemant&solutionID=2412&MaxRows=20000&pageno=0&instrumentid=1000589&StartDate=' + periodStartDate + '', function (data) {
