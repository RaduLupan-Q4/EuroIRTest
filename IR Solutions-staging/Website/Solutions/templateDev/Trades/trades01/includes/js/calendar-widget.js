...
if (language == undefined || language == 'en') {
    ...
    $.getJSON('https://ir.euroinvestor.com/ServiceEngine/api/json/reply/RequestNewsCalendarPagination?apiversion=1&lcid=1033&customerKey=WilliamDemant&solutionID=2412&MaxRows=' + amountOfRows + '&pageno=0&instrumentid=1000589&StartDate=' + convertedDate, function (data) {
        var allData = data;
