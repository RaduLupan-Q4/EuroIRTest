...
<body style="font-size: 16px;">
    ...
    <div class="content">
        ...
        <div class="pageRegister">
            ...
            <div class="subPageLoginConfirm pageVerification_placedAtSubmitbutton">
                ...
                <form action="emailAlerts.aspx">
                    <div class="registrationLightBox">
            ...
            <form action="emailAlerts.aspx">
                ...
                <div class="blockNoBorder pageVerification_placedAtSubmitbutton">
                    ...
                    <input type="button" class="formRegister alertTypeSubmitBox buttonStyle clearInput" id="alertTypeSubmitBox_register" value="Register" />
    ...
    <div class="transparantOverlay hidden"></div>
</body>
</html>
