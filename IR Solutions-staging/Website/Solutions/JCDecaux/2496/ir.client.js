var clientStyleOverwrite = new function ()
{
    ...
    this.amountOfHistoricalYears = 20;
    this.flipDecimalAndThousandSeparators = true;
    this.chart_Colours = [null, '#169BB2', '#37A741', '#B88F00', '#138808', '#3B444B', '#4B5320', '#507D2A', '#556B2F', '#FF0000', '#779ECB', '#915C83', '#91877D', '#FF00DC', '#967117', '#9932CC', '#00FF90', '#A4C639', '#B2EC5D', '#CBA135', '#CD9575', '#91877D', '#967117', '#FF8C00', '#779ECB', '#A4C639'];
}
