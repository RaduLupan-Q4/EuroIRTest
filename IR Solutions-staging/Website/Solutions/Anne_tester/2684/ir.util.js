...
function getTooltipStrSubHistorical(dateIndex) {
    ...
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideOpen) {
        ...
        // if (typeof (globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex]) != 'undefined') {
        tooltipStr += "<div class=\"IRChartTooltipOpen\"><span class=\"subHeader\">" + getOHLCfromTranslations('o') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][1]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][1]) + "</span></div>";
        //}
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideHigh) {
        ...
        // if (typeof (globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex]) != 'undefined') {
        tooltipStr += "<div class=\"IRChartTooltipHigh\"><span class=\"subHeader\">" + getOHLCfromTranslations('h') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][2]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][2]) + "</span></div>";
        //}
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideLow) {
        ...
        //if (typeof (globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex]) != 'undefined') {
        tooltipStr += "<div class=\"IRChartTooltipLow\"><span class=\"subHeader\">" + getOHLCfromTranslations('l') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][3]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][3]) + "</span></div>";
        //}
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideClose) {
        ...
        //if (typeof (globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex]) != 'undefined') {
        tooltipStr += "<div class=\"IRChartTooltipClose\"><span class=\"subHeader\">" + getOHLCfromTranslations('c') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][4]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][4]) + "</span></div>";
        //}
...
function getTooltipStrSubIntraday(dateIndex) {
    ...
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideOpen) {
        ...
        tooltipStr += "<div class=\"IRChartTooltipOpen\"><span class=\"subHeader\">" + getOHLCfromTranslations('o') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][1]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][1]) + "</span></div>";
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideHigh) {
    }
    else {
        tooltipStr += "<div class=\"IRChartTooltipHigh\"><span class=\"subHeader\">" + getOHLCfromTranslations('h') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][2]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][2]) + "</span></div>";
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideLow) {
    }
    else {
        tooltipStr += "<div class=\"IRChartTooltipLow\"><span class=\"subHeader\">" + getOHLCfromTranslations('l') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][3]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][3]) + "</span></div>";
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideClose) {
    }
    else {
        tooltipStr += "<div class=\"IRChartTooltipClose\"><span class=\"subHeader\">" + getOHLCfromTranslations('c') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][4]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][4]) + "</span></div>";
    }
    if (globalChartUseCustomTooltipContent && clientStyle.chart_TooltipHideVolume) {
    }
    else {
...
function getTooltipStrSubTSR(dateIndex) {
    ...
    if (chartFeatureMode == chartDisplayModes.intraday) {
        ...
        tooltipStr += "<div class=\"IRChartTooltipClose\"><span class=\"subHeader\">" + getOHLCfromTranslations('c') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingStockData[globalActiveListingIndex][dateIndex][1]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingStockData[globalActiveListingIndex][dateIndex][1]) + "</span></div>";
        tooltipStr += "<div class=\"IRChartTooltipVolume\"><span class=\"subHeader\">" + getOHLCfromTranslations('v') + "</span><span class=\"subShadow\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][5]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][dateIndex][5]) + "</span></div>";
        tooltipStr += "<div class='tooltipSep'></div>";

        for (var i = 0; i < IRChartTSRfeature.activeTSR.length; i++) {
            tooltipStr += "<div><span class=\"subHeader\"><span class=\"colorIndicator color" + globalChartColours[i + 1].replace('#', '') + " active\"></span>" + IRChartTSRfeature.activeTSR[i].replace("Data", "").replace("dividend", "") + ": </span><span class=\"subShadow\">" + formatLocal(IRChartTSRfeature[IRChartTSRfeature.activeTSR[i]][dateIndex][1]) + "</span><span class=\"subContent\">" + formatLocal(IRChartTSRfeature[IRChartTSRfeature.activeTSR[i]][dateIndex][1]) + "</span></div>";
        }
    }
    ...
    switch (globalChartActiveDisplayMode) {
        case chartDisplayModes.historical:
            try {
                ...
                tooltipStr += "<div>" + getOHLCfromTranslations('c') + " " + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][newDateIndex][4]) + "</div>";
        ...
        case chartDisplayModes.intraday:
            try {
                ...
                tooltipStr += "<div><span class=\"subHeader\">" + getOHLCfromTranslations('c') + "</span><span class=\"subContent\">" + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][dateIndex][4]) + "</div>";
                ...
                tooltipStr += "<div>" + getOHLCfromTranslations('c') + " " + formatLocal(globalChartListingIntradayDataOHLCV[globalActiveListingIndex][newDateIndex][4]) + "</div>";
...
function attachClickHandlers(module) {
    ...
    if (useIRChartSettings) {
        ...
        $('.IRChartSettingsBody .basicButtonLook').click(function () {
    ...
    switch (module) {
        ...
        case 'IRChart':
            ...
            if (typeof ($('.IRChartMenuTrigger')) != "undefined") {
                ...
                $('.IRChartTSRHeader, .IRChartTAHeader, .IRChartComparisonHeader, .IRChartCCHeader').on('click', function () {
                    $('.IRChartMenuTrigger').addClass('icon-arrow');
                    $('.IRChartMenuTriggerBody').css('display', 'none');
                });
...
function updateTooltipComparisonDC(date) {
    ...
    try {
        ...
        var newDateIndex = getClosestDateIndexForListingClosePrice(date);
        tooltipStr += "<div>" + new moment(globalChartListingStockDataOHLCV[globalActiveListingIndex][newDateIndex][0]).format(clientStyle.formatDate) + "</div>";
        tooltipStr += "<div><span class=\"subHeader\"><span class=\"colorIndicator active\" style=\"border-left-color: " + globalChartColours[0] + ";\"></span>" + globalRawStockData[globalActiveListingIndex].symbol + ": </span><span class=\"subShadow\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][newDateIndex][1]) + "</span><span class=\"subContent\">" + formatLocal(globalChartListingStockDataOHLCV[globalActiveListingIndex][newDateIndex][1]) + "</span></div>";
        for (var i = 0; i < globalChartComparisonData[0].length; i++) {
            if (globalChartComparisonInChart[i + 1] == 1) {
                tooltipStr += "<div><span class=\"subHeader\"><span class=\"colorIndicator color" + globalChartColours[i + 1].replace('#', '') + " active\"></span>" + globalChartComparisonSymbols[i] + ": </span><span class=\"subShadow\">" + formatLocal(globalChartComparisonData[0][i][newDateIndex][1]) + "</span><span class=\"subContent\">" + formatLocal(globalChartComparisonData[0][i][newDateIndex][1]) + "</span></div>";
            }
        }
    }
    tooltipStr += "</div>";
...
function resetIRChartNavigation() {
    ...
    console.log(globalChartActiveDisplayMode)
    if (globalChartActiveDisplayMode != chartDisplayModes.comparison) {
