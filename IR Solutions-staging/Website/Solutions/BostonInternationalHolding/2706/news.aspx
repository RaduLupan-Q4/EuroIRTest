        ...
        <div class="news-filter-wrapper">
            <div class="filter-wrapper">
                <div class="search-filter-wrapper">
                    ...
                    <div class="filterRow">
                        <span class="textArea">Search within :</span>
                ...
                <div class="datepicker">
                    <div class="search-from">
                        <label for="from-datepicker" class="textArea input-label from-label">From :</label>
                        <div class="select-date">
                            {{{newsSelectFromYear}}} {{{newsSelectFromMonth 'MMMM'}}}
                        </div>
                    </div>
                    <div class="search-to">
                        <label for="to-datepicker" class="textArea input-label to-label">{{headers/t_to}}: </label>
                        <div class="select-date">
                            {{{newsSelectToYear}}} {{{newsSelectToMonth 'MMMM'}}}
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div>
            ...
            <div class="IRNewsTool table-look horizontal responsive">
                <div class="IRHeaderGroup">
                    ...
                    <div class="IRHeader file-type column-last">Download</div>
                </div>
                ...
                <div class="IRDataGroup" id="{{storyID}}">
                    ...
                    <div class="IRData IRDate" id="{{showDateWithFormat timestamp 'YYYY-MMM-DD'}}">{{showDateWithFormat timestamp 'DD.MM.YYYY'}}</div>
