...
function preloadIRProfileDataEntry(stockData) {
    ...
    function data(w1, m1, m3, m6, m9, y1) {
        this.w1 = w1;
        this.m1 = m1;
        this.m3 = m3;
        this.m6 = m6;
    ...
    return new data(
        getProfilePerformanceDataForPeriod('w1', 'close', closePriceData[globalActiveListingIndex].data, globalRawStockData[globalActiveListingIndex], 'listing'),
        ...
        getProfilePerformanceDataForPeriod('m6', 'close', closePriceData[globalActiveListingIndex].data, globalRawStockData[globalActiveListingIndex], 'listing'),
        getProfilePerformanceDataForPeriod('m9', 'close', closePriceData[globalActiveListingIndex].data, globalRawStockData[globalActiveListingIndex], 'listing'),
...
function preloadIRPerformanceData(closePriceData, stockData, typeOfData) {
    ...
    var datas = [];
    function data(symbol, name, currency, last, w1, m1, m3, m6, m9, y1, yt1, yt2, timestamp, tradeTimestamp) {
        this.symbol = symbol;
        this.name = name;
        ...
        if (typeOfData == 'listing') {
            datas.push(
                new data(
                    ...
                    getDataForPeriod('w1', 'close', closePriceData[i].data, stockData[i], typeOfData),
                    ...
                    getDataForPeriod('m9', 'close', closePriceData[i].data, stockData[i], typeOfData),
            ...
            if (closePriceData[i].instrumentType == 'Index') {
                ...
                datas.push(
                    new data(
                        ...
                        getDataForPeriod('w1', 'close', closePriceData[i].data, null, typeOfData),
                        ...
                        getDataForPeriod('m9', 'close', closePriceData[i].data, null, typeOfData),
...
function getDataForPeriod(period, useOpenHighLowOrClose, closePriceData, stockData, typeOfData) {
    ...
    switch (period) {
        case "d1":
            ...
            break;
        case "w1":
            unixDate = new moment(new moment().add(-7, 'days').format("YYYY-MM-DD")).valueOf();
            break;
        case "m1":
        ...
        case "m6":
            ...
            break;
        case "m9":
            unixDate = new moment(new moment().add(-270, 'days').format("YYYY-MM-DD")).valueOf();
            break;
        case "y1":
    ...
    var dates = [];
    for (var i = 0; i < closePriceData.length; i++) {
        //Replaced newmoment with Date.parse - MD/MJ
        //dates.push(new moment(new moment(closePriceData[i].date).format("YYYY-MM-DD")).valueOf());
        dates.push(Date.parse(closePriceData[i].date));
    ...
    switch (useOpenHighLowOrClose) {
        case 'close':
            if (typeOfData == 'listing') {
                ...
                return (((closePriceData[closePriceData.length - 1].closePrice - closePriceData[index].closePrice) / closePriceData[index].closePrice) * 100);
                //return formatDecimal(((stockData.last - closePriceData[index].closePrice) / closePriceData[index].closePrice) * 100);
            }
