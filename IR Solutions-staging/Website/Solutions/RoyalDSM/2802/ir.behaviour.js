...
Handlebars.registerHelper('includeIRChartNavigation', function () {
    ...
    if (useIRChartTA) {
        ...
        ret += '<div class="basicButtonLook color' + globalChartColours[1].replace('#', '') + '" data-color="' + globalChartColours[1] + '" data-type="' + chartTechnicalAnalysisNamesCC.CommodityChannelIndex + '">' + chartTechnicalAnalysisNames.CommodityChannelIndex + '</div>';
        ret += '<div class="basicButtonLook color' + globalChartColours[2].replace('#', '') + '" data-color="' + globalChartColours[2] + '" data-type="' + chartTechnicalAnalysisNamesCC.DirectionalMovementIndex + '">' + chartTechnicalAnalysisNames.DirectionalMovementIndex + '</div>';
        ret += '<div class="basicButtonLook color' + globalChartColours[3].replace('#', '') + '" data-color="' + globalChartColours[3] + '" data-type="' + chartTechnicalAnalysisNamesCC.ExponentialMovingAverage + '">' + chartTechnicalAnalysisNames.ExponentialMovingAverage + '</div>';
        ret += '<div class="basicButtonLook color' + globalChartColours[4].replace('#', '') + '" data-color="' + globalChartColours[4] + '" data-type="' + chartTechnicalAnalysisNamesCC.Momentum + '">' + chartTechnicalAnalysisNames.Momentum + '</div>';
        ret += '<div class="basicButtonLook color' + globalChartColours[5].replace('#', '') + '" data-color="' + globalChartColours[5] + '" data-type="' + chartTechnicalAnalysisNamesCC.MoneyFlowIndex + '">' + chartTechnicalAnalysisNames.MoneyFlowIndex + '</div>';
        ret += '<div class="basicButtonLook color' + globalChartColours[6].replace('#', '') + '" data-color="' + globalChartColours[6] + '" data-type="' + chartTechnicalAnalysisNamesCC.RateOfChange + '">' + chartTechnicalAnalysisNames.RateOfChange + '</div>';
        ret += '<div class="basicButtonLook color' + globalChartColours[7].replace('#', '') + '" data-color="' + globalChartColours[7] + '" data-type="' + chartTechnicalAnalysisNamesCC.RelativeStrengthIndex + '">' + chartTechnicalAnalysisNames.RelativeStrengthIndex + '</div>';
        ret += '<div class="basicButtonLook color' + globalChartColours[8].replace('#', '') + '" data-color="' + globalChartColours[8] + '" data-type="' + chartTechnicalAnalysisNamesCC.SimpleMovingAverage + '">' + chartTechnicalAnalysisNames.SimpleMovingAverage + '</div>';
        ret += '<div class="basicButtonLook color' + globalChartColours[9].replace('#', '') + '" data-color="' + globalChartColours[9] + '" data-type="' + chartTechnicalAnalysisNamesCC.WilliamsPercentR + '">' + chartTechnicalAnalysisNames.WilliamsPercentR + '</div>';
