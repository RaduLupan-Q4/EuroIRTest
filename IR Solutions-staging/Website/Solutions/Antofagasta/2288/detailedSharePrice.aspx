...
<%--<iframe id="chartiframe" style="width: 100%; float: left; height: 680px; overflow: hidden; border: none; background-color:transparent;" src="about:blank"></iframe>--%>
...
<script id="IRQuoteTableHorizontalTemplate" type="text/x-handlebars-template">
    ...
    <table class="IRDetailedSharePrice table-look horizontal responsive-flip">
        ...
        <tr>
            ...
            <td class="Data market-cap">{{showLondonMarketCapM marketCap}}m GBP</td>
        </tr>
        {{/stocks}}
    </table>
    ...
    <table class="IRDetailedSharePrice table-look vertical responsive-flip">
        ...
        <tr>
            ...
            {{/headers}}
           {{#stocks}}
            <td class="Data exchange"><span class="desktopOnly">{{exchangeName}}</span><span class="mobileOnly">LSE</span></td>
            {{/stocks}}
        </tr>
        <tr>
            {{#headers}}
