    ...
    <div>
        ...
        <div class="IRNewsTool table-look horizontal responsive">
            <div class="IRHeaderGroup">
                ...
                <div class="IRHeader column-last file-type">{{headers/t_view}}/{{headers/t_download}}</div>
            </div>
            <div class="NewsDataGroupWrapper">
                {{#each data}}
                <div class="IRDataGroup" id="{{storyID}}">
                    <div class="IRData column-first IRTitle " id="{{ShowCategoryShort categories}}">{{headline}}</div>
                    <div class="IRData IRDate" id="{{showDateWithFormat timestamp 'YYYY-MMM-DD'}}">{{showDateWithFormat timestamp 'DD.MM.YYYY HH:mm' }}</div>
