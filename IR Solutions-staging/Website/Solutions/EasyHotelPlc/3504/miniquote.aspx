...
$( document ).ajaxStop(function() {
  	var change = $(".change span").attr('class');
  	var changeVal = $(".change span").text();

	if (change == "formatColourNeg") {
		$(".change span").html("<span style='color: #000'>(</span>" + changeVal + "<span style='color: #000'>)</span>");
	} 
