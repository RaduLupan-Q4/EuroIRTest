...
<% 
    // Settings
    string activeClient = "Torm A/S";
    int solutionID = 2230;
    int instrumentID = 27644831;
...
<head>
    ...
    <link rel="stylesheet" href="//cloud.typography.com/7594474/696708/css/fonts.css" type="text/css" />
...
If you would like to unsubscribe, please login and press the <strong>Unsubscribe</strong> button.</p><br/>
                    ...
                    <div class="input-wrapper">
                        ...
                        <button class="formLogin buttonStyle clearInput progress-button" type="button" value="Submit" /><span class="content">Submit</span>
                    </div>
                </form>
