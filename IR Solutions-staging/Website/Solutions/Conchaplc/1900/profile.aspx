...
<% 
    ...
    site.appendCustomCSSURL = "http://www.investorcom.co.uk/SharePriceChart/ConchaPLC.css";
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Personal Goods</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">B8Y8209</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">GB00B8Y82097</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data date-listed">9/23/2005</td>
                    </tr>
                </table>
            </div>
