...
//var emailAlertsManagerURL = 'http://localhost:55794/EmailAlertsManagerRSS.aspx?ts=' + (new Date).getTime();

function prepareTool() {

    $('.listingSettingsTrigger').on('click', function () {
        if ($(this).hasClass('active')) {
            $(this).removeClass('active');
            $(this).siblings('.listingSettingsTrigger').removeClass('active');
            $(this).siblings('input.listingSettingsTrigger').prop('checked', false);
            $(this).siblings('.listingSettings').hide();
        } else {
            $(this).addClass('active');
            $(this).siblings('.listingSettingsTrigger').addClass('active');
            $(this).siblings('input.listingSettingsTrigger').prop('checked', true);
            $(this).siblings('.listingSettings').show();
        }
        console.log($('input.listingSettingsTrigger').prop('checked'));
    ...
    //$('.rssFiltersSelect, .sharePriceSelect').on('click', function () {
    ...
    //$('.releasesTrigger').on('click', function () {
    //    if ($(this).hasClass('active')) {
    //        $(this).removeClass('active');
    //        $(this).siblings('.releasesTrigger').removeClass('active');
    //        $(this).siblings('input.releasesTrigger').prop('checked', false);
    //        $(this).siblings('.alertTypeWrapper').children('.rssFiltersSelect').prop('checked', false);
    //    } else {
    //        $(this).addClass('active');
    //        $(this).siblings('input.releasesTrigger').prop('checked', true);
    //        $(this).children('.rssFiltersSelect').prop('checked', true);
    //    }
    //});
    ...
    $('.buttonRegister').on('click', function () {
        ...
        if (registerFirstName.length < 2) {
            ...
            console.log('registerFirstName = false');
        }
        else {
            check_registerFirstName = true;
            console.log('registerFirstName = true');
        }

        if (registerSurName.length < 2) {
            $('.requiredField').addClass('redBorder');
            check_registerSurName = false;
            console.log('registerSurName = false test');
        }
        else {
            check_registerSurName = true;
            console.log('registerSurName = true');
        }
        ...
        console.log("isCheckedSharePriceOpen: " + isCheckedSharePriceOpen);
        console.log("isCheckedSharePriceWeekly: " + isCheckedSharePriceWeekly);
        console.log("isCheckedSharePriceThresshold: " + isCheckedSharePriceThresshold);
        console.log("isCheckedSharePricePercentage: " + isCheckedSharePricePercentage);
        console.log("isCheckedReleases: " + isCheckedReleases);

        if (!check_registerEmailAddress || !check_registerFirstName || !check_registerSurName) {
