...
<% 
    ...
    string language = "en";
    int solutionID = 2098; // prod is 2098
    int newsSourceID = 1021; // prod is 1021
...
<script id="IREmailAlertTemplate" type="text/x-handlebars-template">
    ...
    <input type="hidden" class="activeClient" value="delekDrilling" />
    ...
    <input type="text" name="registerCompany" id="registerCompany" value=""><br>
    ...
    <div class="alertTypeWrapper">
        <input id="alertType_shareDelekDrilling" class="alertTypeCheckbox listingSettingsTrigger" type="checkbox" />
        <span class="alertTypeLabel listingSettingsTrigger">Delek Drilling</span>
        <div class="listingSettings" id="1793250" style="display: none;">
            ...
            <div class="alertTypeWrapper">
                ...
                <span class="alertTypeLabel alertTypeLabelAllNews">{{headers/t_all_news_types}}</span>
                <div class="alertTypeWrapper">
    ...
    <div class="alertTypeWrapper">
        <input class="alertTypeCheckbox listingSettingsTrigger" type="checkbox">
        <span class="alertTypeLabel listingSettingsTrigger">Avner Oil</span>
        <div class="listingSettings" id="1793204" style="display: none;">
