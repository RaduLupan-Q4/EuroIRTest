...
<script id="IRNewsTemplate" type="text/x-handlebars-template">
    ...
    <div class="news-filter-wrapper">
        ...
        <div  style="padding: 10px;" class="filter-wrapper">
            <div style=" float: left; width:250px;" class="search-filter-wrapper">
                    <div class="search-for-box">
                        <div class="textArea">{{headers/t_searchFor}}:</div>
                        <input style="width: 138px;" class="searchText" value="" type="text" placeholder="{{headers/t_searchHere}}" onfocus="this.placeholder = ''" onblur="this.placeholder = '{{headers/t_searchHere}}'" />
                    </div>
                    <div class="filterRow">
                        <div class="textArea">{{headers/t_from}}:</div>
            ...
            <div style=" float: left; width:500px;" class="datepicker">
                <div class="search-from">
                    <label for="from-datepicker" class="input-label from-label"><div class="textArea">{{headers/t_searchFrom}}:</div></label>
                ...
                <div class="search-to">
                    <label for="to-datepicker" class=" input-label to-label"><div class="textArea">{{headers/t_to}}:</div> </label>
                    <div class="select-date">
            ...
            <div class="submitButton">
                <button type="submit" class="newsSubmit" >{{headers/t_submit}}</button>
            </div>
    ...
    <div>
        ...
        <div class="IRNewsTool table-look horizontal responsive" style="margin-top: 10px;">
            <div class="IRHeaderGroup row">
                <div class="IRHeader IRTitle">Articles <%--{{headers/t_title}}--%></div>
            ...
            {{#each data}}
                <div class="IRDataGroup row" id="{{storyID}}">
