...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.getJSON(getServiceEngingeURL() + 'RequestNewsCalendarPagination?apiversion=1&lcid=1033&customerKey=WilliamDemant&solutionID=2412&MaxRows=100&pageno=0&instrumentid=1000589&StartDate=2013-04-01' + '&EndDate=' + convertedDate + '&sortAscDesc=desc', function (data) {
    ...
    function selectPeriod() {
        ...
        $.getJSON(getServiceEngingeURL() + 'RequestNewsCalendarPagination?apiversion=1&lcid=1033&customerKey=WilliamDemant&solutionID=2412&MaxRows=20000&pageno=0&instrumentid=1000589&StartDate=' + periodStartDate + '', function (data) {
