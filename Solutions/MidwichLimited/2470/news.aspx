...
<% 
    ...
    site.appendCustomCSSFont = @"<link rel=""stylesheet"" href=""//fonts.googleapis.com/css?family=Raleway:400,300,500,700,600"" type=""text/css"" />";
        ...
        <div>
            ...
            <div class="IRNewsTool table-look horizontal responsive">
                <div class="IRHeaderGroup">
                    ...
                    <div class="IRHeader file-type column-last">File Type</div>
                </div>
                ...
                <div class="IRDataGroup" id="{{storyID}}">
                    ...
                    <div class="IRData IRDate column-first" id="{{showDateWithFormat timestamp 'YYYY-MMM-DD'}}">{{showDateWithFormat timestamp 'DD MMMM YYYY'}}</div>
