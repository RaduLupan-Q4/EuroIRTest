    ...
    <div>
        <div class="IRNewsTool table-look horizontal responsive">
            ...
            <div class="IRHeaderGroup">
                <div class="IRHeader IRDate column-first"></div>
                <div class="IRHeader IRTitle"></div>
            ...
            {{#each data}}
                <div class="IRDataGroup" id="{{storyID}}">
                    <div class="IRData IRDate column-first" id="{{showDateWithFormat timestamp 'YYYY-MMM-DD'}}" style="border-bottom: 0;">{{showDate timestamp}}</div>
                    <div class="IRData IRTitle" style="border-bottom: 0;" id="{{ShowCategoryShort categories}}">{{headline}}</div>
                    <%-- <td class="Data time">{{showTime timestamp}}</td>--%>
                    <div class="IRData IRDownload" style="border-bottom: 0;">
                        <div class="IRDownloadPDF">
                            {{{showRNSPDF pdfUrl}}}
                        </div>
                        <div class="IRDownloadKB">
                            <a href="{{pdfUrl}}" target="_blank">{{showFileSize pdfFileSize}}</a>
