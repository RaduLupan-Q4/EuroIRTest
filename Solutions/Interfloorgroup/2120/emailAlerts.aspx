...
<% 
    // Settings
    string activeClient = "Interfloorgroup";
    int solutionID = 2120;
    int instrumentID = 10168319;
        ...
        <div class="pageRegister">
            ...
            <div class="subPageLogin">
                ...
                <form action="emailAlerts.aspx">
                    ...
                    <div>
                        <input class="formLogin buttonStyle clearInput" type="button" value="Submit" /></div>
                </form>
                    ...
                    <div class="blockOuter indent">
                        <label>
                            <div class="checkboxOuter">
                                <%--<input tabindex="7" type="checkbox" class="checkbox checkboxRelease ReleasesA" id="ReleasesA" />--%>
                                <div id="ReleasesA" class="checkbox checkboxRelease ReleasesA"></div>
                            </div>
                        ...
                        <label>
                            <div class="checkboxOuter">
                              <%--  <input tabindex="8" type="checkbox" class="checkbox checkboxRelease ReleasesC" id="ReleasesC" />--%>
                                     <div id="ReleasesC" class="checkbox checkboxRelease ReleasesC"></div>
                            </div>
