...
<div class="IRNewsModule newsHeadline"></div>
...
<script id="IRNewsEntriesTemplate" type="text/x-handlebars-template">
    ...
    <div class="test">
        <div class="IRNewsTool table-look horizontal responsive">
            ...
            {{#each data}}
                ...
                <div class="IRDataGroup" id="{{storyID}}">
                    <div class="IRData IRDate column-first" id="{{showDateWithFormat timestamp 'YYYY-MM-DD HH:mm'}}">{{showDateWithFormat timestamp 'DD MMM YYYY'}}</div>
                    <div class="IRData IRTitle" id="{{ShowCategoryShort categories}}">{{headline}}</div>
                    <div class="IRData IRDownload" style="display: none">
        ...
        <div class="IRNewsTableFooter" style="display: none">
