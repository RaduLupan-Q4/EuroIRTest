...
<% 
    // Settings
    string activeClient = "Targovax";
    int solutionID = 3470;
    int instrumentID = 31364380;
        ...
        <div class="pageRegister">
            ...
            <div class="subPageLogin">
             ...
             <!--   <p>
               ...
               <form action="emailAlerts.aspx">
                    ...
                    <span class="inputTextTitle">Email address</span>
           ...
           <p>
            ...
            <form action="emailAlerts.aspx">
                ...
                <div class="blockOuter">
                    ...
                    <div class="blockInner">
                        <div class="inputTextTitle">
                            <%= titleEmailAdress %><span style="color: #cc0000; font-weight: bold"> *</span> 
                        </div>
                        <div class="inputText">
                    ...
                    <div class="blockInner">
                        <div class="inputTextTitle">
                            <%= titleFirstName %><span style="color: #cc0000; font-weight: bold"> *</span> 
                        </div>
                        <div class="inputText">
                    ...
                    <div class="blockInner">
                        <div class="inputTextTitle">
                            <%= titleLastName %><span style="color: #cc0000; font-weight: bold"> *</span> 
                        </div>
                        <div class="inputText">
                ...
                <p>
                    Select the alerts you wish to receive. <span style="color: #cc0000; font-weight: bold"> *</span>
                </p>
