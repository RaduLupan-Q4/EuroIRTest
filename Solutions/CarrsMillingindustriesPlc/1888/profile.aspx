...
<% 
    ...
    site.appendCustomCSSURL = "http://www.investorcom.co.uk/SharePriceChart/CarrsMilling.css";
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Food Producers</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">BRK0105</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">GB00BRK01058</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data market-segment">SSMM</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data nms">1500</td>
                    </tr>
                    <tr>
                        <td class="Header date-listed">Date Listed</td>
                        <td class="Data date-listed">5/23/1972</td>
                    </tr>
                </table>
            </div>
