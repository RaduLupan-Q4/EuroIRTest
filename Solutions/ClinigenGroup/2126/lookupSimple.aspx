...
<script id="IRLookupTemplate" type="text/x-handlebars-template">
    ...
    <form id="lookup-form" method="POST">
        <div class="input-row fromDatepicker">
        ...
        <div class="input-row toDatepicker">
        ...
        <div class="input-row frequencyWrapper">
        ...
        <div class="input-row formatWrapper">
        ...
        <div class="input-row">
            <div class="input-wrapper submitButtonWrapper">
