...
<script id="IRQuoteTableHorizontalTemplate" type="text/x-handlebars-template">
    ...
    <h3 class="horizontal-header">High/Low share price information (GBX)</h3>
        <div class="divideLine horizontal"></div>
     <table class="IRDetailedSharePrice table-look horizontal responsive-flip">
        {{#headers}}
        <tr>
    ...
    <table class="IRDetailedSharePrice table-look vertical responsive-flip">
      ...
      <h3 class="vertical-header">High/Low share price information (GBX)</h3>
        <div class="divideLine vertical"></div>
    <table class="IRDetailedSharePrice table-look vertical responsive-flip">
    ...
    <div class="iframe-wrapper" style="height: 1308px;">
    <h3>Share Price throughout the Day</h3>
        <div class="divideLine"></div>
    <iframe src="http://ir1.euroinvestor.com/asp/ir/ClinigenGroup/detailedSharePrice.aspx" style="width: 100%; border: none; height: 1308px;"></iframe>
    </div>
