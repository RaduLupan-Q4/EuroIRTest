...
<% 
    ...
    site.appendCustomCSSURL = "//www.investorcom.co.uk/SharePriceChart/MCC.css";
...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <div class="profile-wrapper">
        ...
        <b>Sector:</b> Oil & Gas Producers<br>
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Oil & Gas Producers</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">B979BX2</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">GB00B979BX21</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="Header nms">Trading service</td>
                        <td class="Data nms">SETSqx</td>
                    </tr>
                    <tr>
                        <td class="Header date-listed">Date Listed</td>
                        <td class="Data date-listed">29 May 2012</td>
                    </tr>
                </table>
            </div>
