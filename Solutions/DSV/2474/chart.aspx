...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    <div class="companyInfoWrapper">
        ...
        <div class="updated"><span>{{headers/t_updated}}: </span><span>{{showDateWithFormat stocks/timestamp 'YYYY-MM-DD HH:mm'}}</span></div>
    </div>
...
<script id="IRChartModuleTemplate" type="text/x-handlebars-template">
    ...
    <div class="accToolLink">
    <a href="http://ir1.euroinvestor.com/asp/ir/DSV/acctool.aspx">Please click here for Text-Alternative Share Price Charting Tool.</a>
        </div>
</script>
