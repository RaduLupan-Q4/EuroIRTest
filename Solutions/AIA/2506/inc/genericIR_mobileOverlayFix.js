...
function loadClickHandlers()
{
    ...
    {
		var isUpdateOrNewSubscription=$(this).val();
        e.preventDefault();
        if (activePage == 1) {
            if (checkInputFields()) {
                activePage = 2;
				...
				if(isUpdateOrNewSubscription=='Subscribe')
				{
					$('.blockOuter').hide();
					$('#successfullysubscribedscreen').show();
				} 
				if(isUpdateOrNewSubscription=='Update Information')
				{
					$('.blockOuter').hide();
					$('#successfullyupdatedscreen').show();
				}
        ...
        if (activePage == 2) {
			...
			if(isUpdateOrNewSubscription=='Subscribe')
			{
                ...
                $.ajax({
                    ...
                    success: function (userData) {
                        if ((userData.userExist+'') == 'True') {
							...
							$('#youarealreadydescribedscreen').show();
                        } else {
				...
				/*
				var userAlreadyExists=doesUserAlreadyExist();
...
function retrieveAndPostValues()
{
    ...
    emailAlertsManagerURL = 'http://localhost:61531/EmailAlertsManager.aspx?ts=' + (new Date).getTime();*/
    ...
    var rssEnabled = $('#ReleaseRSS').hasClass('checked')+'';
    if (rssEnabled == 'true') {
        rssEnabled = 'checked';
    } else {
        rssEnabled = 'na';
	...
	console.log('ReleasesA: '+checkReleases('ReleasesA'));
console.log('ReleasesB: '+checkReleases('ReleasesB'));
console.log('ReleasesC: '+checkReleases('ReleasesC'));
console.log('language: '+$('#companyAnnoucementLanguage').val());
console.log('emailEOD: '+$('#emailEOD').attr('checked'));
console.log('emailBOD: '+$('#emailBOD').attr('checked'));
console.log('emailWeekly: '+$('#emailWeekly').attr('checked'));
console.log('emailThreshold: '+$('#emailThreshold').attr('checked'));
console.log('inputBoxLow: '+$('#inputBoxLow').val());
console.log('inputBoxHigh: '+$('#inputBoxHigh').val());
console.log('emailChangePercentage: '+$('#emailChangePercentage').attr('checked'));
console.log('inputBoxChangePercentage: '+$('#inputBoxChangePercentage').val());
console.log('enterInformationFirstName: '+$('#enterInformationFirstName').val());
console.log('enterInformationEmail: '+$('#enterInformationEmail').val());
console.log('enterInformationCompany: '+$('#enterInformationCompany').val());
console.log('enterInformationLastName: '+$('#enterInformationLastName').val());
console.log('enterInformationTitle: '+$('#enterInformationTitle').val());
console.log('//enterInformationType: '+$('#enterInformationType').val());
console.log('enterInformationCountry: '+$('#enterInformationCountry').val());
console.log('enterInformationCompany: '+$('#enterInformationCompany').val());
console.log('enterInformationProfession: '+$('#enterInformationProfession option:selected').val());
console.log('unsubscribeEmail: '+$('#unsubscribeEmail, .enterInformationLoginEmail, .unsubscribeEmail').val());
console.log('solutionID: '+$('.solutionID').val());
console.log('instrumentID: '+$('.instrumentID').val());
console.log('feedURL: '+$('#feedURL').val());
console.log('activeClient: '+$('.activeClient').val());
console.log('enterInformationEmailRSS: '+$('#enterInformationEmailRSS').val());
console.log('ReleaseRSS: ' + rssEnabled);
console.log('enterInformationName: '+$('#enterInformationName').val());
console.log('useRSSFilters: '+useRSSFilters);
console.log('RSSFilters: '+RSSFilters);
console.log('useRNSFilters: '+useRNSFilters);
console.log('RNSFilters: '+RNSFilters);
console.log('enterInformationEmailRNSFilter: '+$('#enterInformationEmailRNSFilter').val());
console.log('ReleaseRNSFilter: '+$('#ReleaseRNSFilter').attr('checked'));
    ...
    $.ajax({
        ...
        data: {
            ...
            enterInformationCompany: $('#enterInformationCompany').val(),
			enterInformationProfession: $('#enterInformationProfession option:selected').val(),
