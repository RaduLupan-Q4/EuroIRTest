...
<% 
                // Settings
                string activeClient = "Morgan Advanced Materials";
                int solutionID = 2414;
                int instrumentID = 14570353;
                bool showLoginToUnsubscribe = true;
                bool showEuroInvestorDisclaimer = false;

                string[] RNSFilters = { "Select all", "Financial Reports", "Annual Report", "Presentation Alert", "Calendar Alert", "Press Releases"};
                string[] RNSFiltersGroup = { "allRNSnews", "ACQ, DIS", "ACS", "NAV", "NOA,NOE,RAG,REG,AGM,EGM", "FR,IR,QRF,QRT,NOR" };
...
<body style="font-size: 16px;">
    ...
    <div class="content emailAlerts">
        ...
        <div class="blockNoBorder pageVerification_placedAtSubmitbutton">  <p class="requiredField">
...
<script type="text/javascript">
    ...
    $('#loginscreen_loginButton').click(function () {
        ...
        $.ajax({
            url: '../../../Tools/EmailAlertsWithPush/EmailAlertsManager.aspx?action=getuserinformation&solutionID=2414&ts=' + (new Date).getTime(),
            //url: 'http://localhost:61531/EmailAlertsManager.aspx?action=getuserinformation&solutionID=2414&ts=' + (new Date).getTime(),
            type: "POST",
            dataType: "json",
            cache: false,
            data: {
