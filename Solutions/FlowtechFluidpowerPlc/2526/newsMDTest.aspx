    ...
    <div class="tab-container">
        ...
        <ul class="list_reset ul-list-tabs">
            <li class="li-tab current pointer" id="tab1">
                ...
                {{{newsFiltersSelect 'NasdaqOMXNordic'}}}
...
<link rel="stylesheet" href="newsMDTest.css?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("newsMDTest.css")).Ticks.ToString()%>" />
