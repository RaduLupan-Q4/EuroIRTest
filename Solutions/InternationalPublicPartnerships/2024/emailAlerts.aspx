...
<% 
    // Settings
    string activeClient = "International Public Partnerships";
    int solutionID = 2024;
    int instrumentID = 2070659;
...
<head>
    ...
    <link rel="stylesheet" href="ir.client.css?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("inc/emailAlerts.css")).Ticks.ToString()%>" />

</head>
<body style="font-size: 16px; overflow: hidden">

    <div class="emailAlerts content">
        ...
        <div class="subPageLogin">
            ...
            <form action="emailAlerts.aspx">
                ...
                <br />
                <span style="emailUnsubscribeLabel"><%= titleEmailAdress %>:</span>
