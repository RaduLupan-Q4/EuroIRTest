...
<script type="text/javascript">
    ...
    var activeFeatures = ['IRChartSettings', 'IRChartCompare', 'IRChartTSR', 'IRChartTechnicalAnalysis', 'IRChartNews'];
</script>
...
<%-- <script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <table class="IRQuoteModule table-look horizontal customResponsive">
        ...
        <tr>
            ...
            <td class="Data Timestamp column-last"id="hideD">{{showDateTime stocks/timestamp}}
        </tr>
        <tr>
