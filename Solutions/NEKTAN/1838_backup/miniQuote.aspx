...
<%--    <h2>Share Price</h2>--%>
    <div class="IRMiniQuoteQuoteModule table-look responsive">
        <div class="miniquoteDetailsWrapper">
            ...
            <div class="Header marketCap">{{headers/t_market_cap}}  </div><div class="Data marketCap"> £{{showLondonMarketCapM stocks/marketCap}}million </div>
      <%--      <div class="Data closeDate">{{showTime time}} at {{showDate stocks/timestamp}} </div>--%>
        ...
        <div class="sharePriceLinkWrapper">
            ...
            <div class="sharePriceLink"><a href="//nektan.com/?ir=detailed-share-price target="_parrent">View Share price details</a></div><div class="arrow"></div>
        </div>
    </div>
</script>
