        ...
        function prepareCustomNewsPagination() {
            ...
            if (!customNewsPagination) {
                ...
                if (typeof ($('.IRNewsPagination').html()) != 'undefined') {
                    ...
                    updatePagination(2);
                    $('.IRNewsPagination').prepend('<a href="#" class="IRNewsPageNumber IRNewsPagePrevNext IRNewsPagePrev">Prev</a>');
                    $('.IRNewsPagination').append('<a href="#"  class="IRNewsPageNumber IRNewsPageNext IRNewsPagePrevNext" style="display: inline;">Next</a>');
