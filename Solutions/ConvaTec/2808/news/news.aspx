            ...
            <div class="filter-wrapper">
                <div class="search-filter-wrapper">
                    <div class="search-for-box">
                        ...
                        <input class="searchText" value="" type="text" placeholder='{{headers/t_search}}'" onblur="this.placeholder='{{headers/t_search}}' " />
            ...
            <div class="NewsDataGroupWrapper">
                ...
                <div class="IRDataGroup" id="{{storyID}}">
                    ...
                    <div class="IRData IRDownload">
                        ...
                        <span class="download-span">Download PDF</span>
    ...
    function applyIRNewsPagination() {
        ...
        if (IRNewsPaginationApplied) {
            ...
            if (typeof ($('.IRNewsPagination').html()) != 'undefined') {
                ...
                var paginationTmp = "";
                paginationTmp += '<div class="IRNewsPaginationPageNew IRNewsPaginationPagePrev" style="display:none; visibility:hidden;" id="prev">Prev</div>';
                ...
                paginationTmp += '<div class="IRNewsPaginationPageNew IRNewsPaginationPageNext" id="next" style="display:none;">Next</div>';
    ...
    function prepareCustomX() {
        if (!customXApplied) {
            if (typeof ($('.IRNewsPagination').html()) != 'undefined') {
                ...
                $(".IRNewsModule .news-filter-wrapper .newsSubmit").trigger("click");
