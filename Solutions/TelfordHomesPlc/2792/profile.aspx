...
<% 
    ...
    //site.appendCustomCSSURL = "//www.investorcom.co.uk/SharePriceChart/TelfordHomes.css";
...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <div class="profile-wrapper">
        ...
        <b>Sector:</b> Household Goods & Home Construction<br>
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Household Goods & Home Construction</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">3102215</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">GB0031022154</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data date-listed">12/14/2001</td>
                    </tr>
                </table>
            </div>
