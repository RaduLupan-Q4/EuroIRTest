...
<div class="IRCalendar">
    <div class="wrapper2">
        ...
        <div class="calendarRemindAllEncapsulator" id="Encapsulator2">
         ...
         <iframe class="calendarArchivedEvents" src="calendarArchivedEvents.aspx" height: 1000px; width: 100%; style="display:none"></iframe>
    </div>
                    ...
                    <div class="headlineWrapper">
                        ...
                        <div class="CalendarContentWrapper">
                            <div class="calendarContent">
                                <span class="calendarTitle">{{headline}} </span><div class="showHideButton" id="showHideButton"></div>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.getJSON(getServiceEngingeURL() + 'RequestNewsCalendarPagination?apiversion=1&lcid=1033&customerKey=WilliamDemant&solutionID=2412&MaxRows=100&pageno=0&instrumentid=1000589&StartDate=' + convertedDate + '&sortAscDesc=asc' + '', function (data) {
    ...
    function selectPeriod() {
        ...
        $.getJSON(getServiceEngingeURL() + 'RequestNewsCalendarPagination?apiversion=1&lcid=1033&customerKey=WilliamDemant&solutionID=2412&MaxRows=20000&pageno=0&instrumentid=205058&StartDate=' + periodStartDate + '', function (data) {
