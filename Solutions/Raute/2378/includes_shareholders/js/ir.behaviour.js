...
Handlebars.registerHelper('selectPeriod', function () {
    ...
    var rutavSecurityInfo = allData.data.securityInfo;
    //var fromDate = new Date();
    for (var i = 0; i < rutavSecurityInfo.length; i++) {
        if (rutavSecurityInfo[i].name == "RUTAV") {
            fromDate = new Date(rutavSecurityInfo[i].dataFrom);
        }
    }
