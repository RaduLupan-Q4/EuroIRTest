...
<% 
    ...
    site.appendCustomCSSFont = @"<link rel=""stylesheet"" href=""//fonts.googleapis.com/css?family=Roboto:400,300,500"" type=""text/css"" />";
...
<script id="IRQuoteTableHorizontalTemplate" type="text/x-handlebars-template">
    ...
    <h3 class="horizontal-header Header">Exchange information</h3>
    <div class="divideLine horizontal"></div>
    ...
    <h3 class="horizontal-header" style="margin-top: 0 !important; width: 100%; float: left;">Current share price information ({{stocks/currency}})</h3>
    <div class="divideLine horizontal"></div>
    <table class="IRDetailedSharePrice table-look horizontal responsive">
        {{#headers}}
        <tr>
            ...
            <th class="Header lastPrice column-last">{{t_last}}</th>
        </tr>
        {{/headers}}
        {{#stocks}}
        <tr>
            ...
            <td class="Data lastPrice column-last">{{decimals last}}</td>
        </tr>
        {{/stocks}}
    </table>

    <h3 class="horizontal-header" style="margin-top: 0 !important; width: 100%; float: left;">High/Low share price information ({{stocks/currency}})</h3>
    <div class="divideLine horizontal"></div>
    <table class="IRDetailedSharePrice table-look horizontal responsive">
    {{#headers}}
    <tr>
    ...
    <h3 class="vertical-header" style="margin-top: 0 !important; width: 100%; float: left;">Current share price information ({{stocks/currency}})</h3>
    <div class="divideLine vertical"></div>
    <table class="IRDetailedSharePrice table-look vertical responsive-flip">
        <tr>
        ...
        <tr>
            {{#headers}}
            <th class="Header last column-last">{{t_last}}</th>
            {{/headers}}
            {{#stocks}}
            <td class="Data last column-last">{{decimals last}}</td>
            {{/stocks}}
        </tr>
    </table>
    <h3 class="vertical-header" style="margin-top: 0 !important; width: 100%; float: left;">Exchange information ({{stocks/currency}})</h3>
    <div class="divideLine vertical"></div>
    <table class="IRDetailedSharePrice table-look vertical responsive-flip">
        <tr>
            {{#headers}}<th class="Header prev-close column-first">{{t_prev_close}}</th>
            {{/headers}}
        ...
        <tr>
            {{#headers}}<th class="Header low52week column-last">{{t_52w_low}}</th>
            {{/headers}}
            {{#stocks}}<td class="Data low52week column-last">{{decimals low52Week}}</td>
            {{/stocks}}
        </tr>
    </table>
