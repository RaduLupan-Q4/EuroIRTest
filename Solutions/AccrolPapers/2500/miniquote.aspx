    ...
    <div class="IRMiniQuoteQuoteModule">
        <div class="miniquoteDetailsWrapper">
            <table class="mQuoteTable">
                <tr>
                    <td class="last" colspan="2">{{decimals stocks/last}} <span class="{{showArrow stocks/change}}"></span></td>
                </tr>
                <tr>
                    <td class="first-col">{{headers/t_change}}</td>
                    <td class="last-col">{{decimals stocks/change}}({{decimals stocks/changePercent}}%)</td>
                </tr>
                <tr>
