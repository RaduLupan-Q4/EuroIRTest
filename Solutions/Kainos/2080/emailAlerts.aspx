...
<% 
    // Settings
    string activeClient = "Kainos";
    int solutionID = 2080;
    int instrumentID = 23465080; // 27574070;
...
If you would like to unsubscribe, please login and press the unsubscribe button.</p><br/>
           ...
           <p>
                ...
                If you would like to receieve email alerts please complete the following and then press Register. <br /> (*indicates a required field).
            </p>
    ...
    <%--<script type="text/javascript" src="https://irssl.euroinvestor.com/ir/tools/EmailAlertsWithPush/inc/generic_mobileOverlayFix.js"></script>--%>
     <script type="text/javascript" src="https://ir.euroinvestor.com/Tools/EmailAlertsWithPush/Inc/genericIR_mobileOverlayFix.js"></script>
