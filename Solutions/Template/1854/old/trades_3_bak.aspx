...
<table class="IROrders table-look table-look-horizontal responsive-horizontal" id="scroll-table"> 
    <tr>
        ...
        <th class="last" style="text-align: right;">Updated <div class="img"><img style="text-align: center; padding-left: 5px; height: 12px;" src="../1854/images/stopwatch.png" alt=""/></div> </th>        
    </tr>
    ...
    <tr>
        <td class="tdmobileview" colspan="6" style="text-align: center; color:#555; font-weight: bold; background: whitesmoke;">20 January 15</td>
    </tr>
    <tr>
        <td class="increase">326.00<img id=higher src="../1854/images/arrow_up.png"></td>
        <td>14</td>
    ...
    <tr>
        <td class="tdmobileview" colspan="6" style="text-align: center; font-weight:bold; color:#555;  bold; background: whitesmoke;">19 January 15</td>
    </tr>
    <tr>
        <td>325.50</td>
        <td>14</td>
    ...
    <tr>
        <td class="tdmobileview" colspan="6" style="text-align: center; font-weight: bold; background: whitesmoke;">18 January 15</td>
    </tr>
    <tr>
        <td>325.50</td>
        <td>14</td>
