            ...
            $("#scroll-table tr").each(function () {
                ...
                if (new moment(prevDate) < new moment(currDate)) {
                     if (amountofTRsToSkip == 0) {
                       $(this).before('<tr><td class="table-seperator" colspan="' + amountOfTDs + '"> ' + new moment(currDate).format(clientStyle.formatDate) + ' </td></tr>');
                       $(this).after('<tr><td class="table-seperator" colspan="' + amountOfTDs + '"> ' + new moment(prevDate).format(clientStyle.formatDate) + ' </td></tr>');
                     } else {
                        $(this).after('<tr><td class="table-seperator" colspan="' + amountOfTDs + '"> ' + new moment(prevDate).format(clientStyle.formatDate) + ' </td></tr>');
                     }
                }
