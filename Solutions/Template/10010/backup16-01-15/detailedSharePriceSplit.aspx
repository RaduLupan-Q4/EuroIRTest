...
<table class="detailed-share-price-records table-look  detailedshareprice detailedshareprice-vertical responsive-flip-vertical"> 
            <th importance="95">{{headers/t_exchange}}</th>
            <td width="173" class="detailed-share-price Highlight"><div align="left">{{stocks/exchangeName}}</div></td>
        </tr>
        <tr>
            <th width="135">{{headers/t_symbol}}</th>
            <td width="151"><div align="left">{{stocks/symbol}}</div></td>
        </tr>
        <tr>
            <th width="135">{{headers/t_currency}}</th>
            <td width="151"><div align="left">{{stocks/currency}}</div></td>
        </tr>
        <tr>
            <th importance="95">{{headers/t_shares_outstanding}}</th>
            <td width="173"><div align="left">{{decimals stocks/shareMillions}}</div></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="151"><div align="left">{{showDate stocks/timestamp}}</div></td>
        </tr>
    </table>

<h2>Share Price Summary</h2>    

<table class="detailed-share-price-summary table-look detailedshareprice detailedshareprice-vertical responsive-flip-vertical"> 
        ...
        <tr>
            ...
            <td width="173"><div align="left">{{decimals stocks/bid}}</div></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="151"><div align="left">{{showMarketCapM stocks/marketCap}}</div></td>
        </tr>
</table>
...
<table class="detailed-share-price-market table-look  detailedshareprice detailedshareprice-vertical responsive-flip-vertical"> 
            ...
            <td width="173"><div align="left">{{decimals stocks/prevClose}}</div></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td width="173"><div align="left">{{decimals stocks/low}}</div></td>
        </tr>
        <tr>
            <th width="135">{{headers/t_52w_high}}</th>
            <td width="151"><div align="left">{{decimals stocks/high52Week}}</div></td>
        </tr>
        <tr>
            <th width="135">{{headers/t_52w_low}}</th>
            <td width="151"><div align="left">{{decimals stocks/low52Week}}</div></td>
        </tr>
        <tr>
