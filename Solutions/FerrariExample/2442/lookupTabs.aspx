    ...
    <div class="tabs-container" >
        ...
        <div id="container" class="tabs">
            ...
            <div id="tab-1">
                ...
                <iframe id="chartSimpleiFrame" src="lookup.aspx" style="width: 100%; height: 600px; margin-top: 20px;"></iframe>

            </div>
            <div id="tab-2">

                <iframe id="chartBasiciFrame" src="lookupGraphical.aspx" style="width: 100%; height: 600px; margin-top: 20px;"></iframe>
