...
<script id="IRNewsTemplate" type="text/x-handlebars-template">
    ...
    <div class="tab-container">
        ...
        <ul class="list_reset ul-list-tabs">
            <div style="display:none;"><!-- HIDING THE FILTER AS IT IS MADE FOR NASDAQ ONLY AND NOT CISION -->
    ...
    <div class="test">
        <div class="IRNewsTool table-look horizontal responsive">
            ...
            <div class="IRHeaderGroup">
                <div class="IRHeader IRDate column-first"> All Releases</div>
...
<script type="text/javascript">
    ...
    function applyIRNewsPagination() {
        ...
        if (IRNewsPaginationApplied) {
            ...
            $('#to-year').prepend($("<option value='allNews'>All Years</option>")); 
            ...
            $("#to-year").html($("#to-year option").sort(function (a, b) {
                return a.text == b.text ? 0 : a.text < b.text ? 1 : -1
            }))

            $('#to-year option:nth-child(1)').prop('selected', true); // To select via index
            ...
            if (typeof ($('.IRNewsPagination').html()) != 'undefined') {
                ...
                // console.log("Items"+globalAmountOfNewsItems);
