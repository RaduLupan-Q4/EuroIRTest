...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <div class="profile-wrapper">
        ...
        <br />
        <b>Sector:</b> Software and Computer Services<br>
        <br />
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Software and Computer Services</td>
                    </tr>
                    <tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">BMJJFZ1</td>
                    </tr>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">GB00BMJJFZ18</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="Data date-listed">19/08/2014</td>
                    </tr>
                </table>
            </div>
