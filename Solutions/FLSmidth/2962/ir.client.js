var clientStyleOverwrite = new function ()
{
    ...
    this.chartCurrencyPlus = ['EUR', 'GBP', 'USD', 'DKK', 'AUD', 'BGN', 'CAD', 'EEK', 'CHF', 'CNY', 'CZK', 'HKD', 'HRK', 'HUF', 'IDR', 'JPN', 'KRW', 'MYR', 'NOK', 'NZD', 'PHP', 'PLN', 'RON', 'RUB', 'SEK', 'SGD', 'THB', 'TRY', 'ZAR'];
};