...
<% 
    // Settings
    string activeClient = "ApaxGlobalAlphaLtd";
    int solutionID = 3468;
    int instrumentID = 27128332;
        ...
        <div class="content">
            ...
            <div class="pageRegister">
                ...
                <form action="emailAlerts.aspx">
                    ...
                    <input type="hidden" name="activeClient" class="activeClient" value="ApaxGlobalAlphaLtd" />
                    <input type="hidden" name="solutionID" class="solutionID" value="3468" />
                    <input type="hidden" name="instrumentID" class="instrumentID" value="27128332" />
