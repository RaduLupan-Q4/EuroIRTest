...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <div class="profile-wrapper">
        ...
        <br>
        <b>{{headers/t_market_cap}}:</b> DKK {{showLondonMarketCapM stocks/marketCap}}m<br>
            ...
            <div class="company-listing-data">
                ...
                <table class="IRTable table-look responsive">
                    ...
                    <tr>
                        ...
                        <td class="Data sector">Consumer Cyclical</td>
                    </tr>
                    <%--<tr>
                        <td class="Header sedol">SEDOL</td>
                        <td class="Data sedol">NULL</td>
                    </tr>--%>
                    <tr>
                        <td class="Header isin">ISIN</td>
                        <td class="Data isin">DK0010237643</td>
                    </tr>
                    <%--<tr>
                        <td class="Header market-sector">Market Sector</td>
                        <td class="Data market-sector">NULL</td>
                    </tr>
                    <tr>
                        <td class="Header market-segment">Market Segment</td>
                        <td class="Data market-segment">NULL</td>
                    </tr>--%>
                    <tr>
                        <td class="Header country">Country of register</td>
                        <td class="Data country">DK</td>
                    </tr>
                    <tr>
                    ...
                    <%--<tr>
                        ...
                        <td class="Data nms">NULL</td>
                    </tr>--%>
<%--                    <tr>
                        <td class="Header date-listed">Date Listed</td>
                        <td class="Data date-listed">04/02/2003</td>
                    </tr>--%>
                </table>
            </div>
                ...
                <table class="IRTable table-look responsive">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="Data market-cap">DKK {{showLondonMarketCapM stocks/marketCap}}m</td>
                        </tr>
                    </tbody>
                </table>
            </div>
