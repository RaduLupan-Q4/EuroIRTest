        ...
        <div class="IRNewsHeadlineTool table-look horizontal responsive">
            {{#each data}}
                <div class="Data headline" id="{{storyID}}">
                    <div class="testtest" id="{{storyID}}"></div><div class="Data date column-first" id="{{showDateWithFormat timestamp 'YYYY-MMM-DD'}}">{{showDateWithFormat timestamp 'DD MMM YYYY HH:mm'}}</div>
