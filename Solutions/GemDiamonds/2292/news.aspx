...
<script type="text/javascript">
    ...
    function preLoadNewsPerformance() {
        ...
        $.each(toolRawNewsData.data, function (i, item) {
            ...
            //Fix issue with NaN return
            if ( bestMatchIndex !== 0 ) {
            change = globalClosePricePrices[bestMatchIndex] - globalClosePricePrices[bestMatchIndex - 1];
            
            console.log(bestMatchIndex);
            
            changePct = parseFloat(((globalClosePricePrices[bestMatchIndex] - globalClosePricePrices[bestMatchIndex - 1]) / globalClosePricePrices[bestMatchIndex - 1]) * 100);
            }
