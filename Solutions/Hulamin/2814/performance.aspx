...
<script id="IRPerformanceModuleTemplate" type="text/x-handlebars-template">
    <table class="IRPerformanceModule table-look horizontal responsive">
        <thead>
            {{#headers}}
            <tr>
                <th class="Header column-first name">{{t_symbol}}</th>
    ...
    <table class="IRPerformanceModule table-look vertical">
		<tr>
			<th class="Header column-first name">{{headers/t_symbol}}</th>
		...
		<tr>
			<th class="Header months6">{{headers/t_1_year}}</th>
			<td class="Data formatColour months6">{{decimals dataListings.0/y1}}</td>
		</tr>
	</table>
</script>
