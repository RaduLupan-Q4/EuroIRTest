...
<script id="IRQuoteTableHorizontalTemplate" type="text/x-handlebars-template">
    ...
    <table class="IRDetailedSharePrice table-look vertical responsive-flip">
        ...
        <tr>
            ...
            {{/headers}}
            {{#stocks}}
            <td class="Data date">{{showTime timestamp}}</td>
            {{/stocks}}
        </tr>
        <tr>
            {{#headers}}
    ...
    <div class="iframe-wrapper" style="height: 1080px; width: 100%;">
        ...
        <iframe src="//irssl.euroinvestor.com/asp/ir/UDGHealthcarePlc/https/detailedSharePrice.aspx" style="width: 100%; border: none; height: 950px;"></iframe>
    </div>
</script>
