...
<script type="text/javascript">
    ...
    var activeFeatures = ['IRChartSettings', 'IRChartCompare', 'IRChartTA', 'IRChartNews', 'IRChartCurrencyConversion'];
</script>
...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    <table class="IRQuoteModule table-look horizontal responsive">
            ...
            <tr>
                ...
                <td class="Data price-at">{{decimals stocks/last}}</td>
    ...
    <div class="updated"><span>{{headers/t_updated}}: {{showDateWithFormat stocks/timestamp 'DD MMM YYYY HH:mm'}} {{showLocalTimeZoneShort}}</span></div>
