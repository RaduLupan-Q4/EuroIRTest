 ...
 <script type="text/javascript">
	...
	<script id="IRLookupTemplate" type="text/x-handlebars-template">
		...
		<form id="lookup-table-form">
			...
			<div>
			<div class="submit" style="">{{t_search}}</div>
			</div>
		</form>
...
<%= site.newFooter("IRLookup") %>
 ...
 <script type="text/javascript">
     function updateTimeframe() {
			var graphUrlTemplate = "lookup.aspx?language="+globalActiveLanguage+"&mode=list&from=__FROM__&to=__TO__&frequency=Daily&listing=0";
