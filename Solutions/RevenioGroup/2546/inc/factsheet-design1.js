...
var clientStyle = new function () {
    ...
    this.chart_ColourPie = ['#213A52', '#2B4D6E', '#366089', '#4C769F', '#7091B2', '#94ADC5', '#B7C8D8', '#2b908f', '#f45b5b', '#91e8e1'];
...
function drawIRChartBase(thisTarget, categories) {
    ...
    $(thisTarget).highcharts('StockChart', {
        colors: ['#F3D9B1', '#E2D4BA', '#E5989B', '#AF7A6D', '#653239', '#7B2D26', '#D7C9AA', '#011502', '#FFFBFA', '#01200F', '#FFBF00', '#E83F6F'],
        chart: {
            animation: false,
            alignTicks: true,
            panning: false,
...
function getFactsheetPathDownloadPDF() {
    return "http://irdev.euroinvestor.com/ir/Files/Factsheets/factsheet_" + getCustomerKeyRequired() + '_' + getSolutionID() + "_" + globalActiveLanguage + ".pdf?cachebust=1";
}
