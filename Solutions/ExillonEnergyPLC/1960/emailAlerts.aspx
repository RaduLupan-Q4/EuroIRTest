...
<% 
    // Settings
    string activeClient = "ExillonEnergyPLC";
    int solutionID = 1960;
    int instrumentID = 2199765;
...
<head>
    ...
    <link rel="stylesheet" href="inc/emailAlerts2.css" />
</head>
...
If you would like to unsubscribe, please login and press the <strong>Unsubscribe</strong> button.</p><br/>
           ...
           <p>
                ...
                Enter your email address and a little information about yourself, and then click on the <strong>Register</strong> button below <br /> (*indicates a required field).
            </p>
            ...
            <form action="emailAlerts.aspx">
                ...
                <div class="blockOuter indent">
                    ...
                    <p style="margin-bottom: 15px;">
                        <br />From time to time, we may use your registration details to provide you with additional information about us and our products and services which may be of interest to you.
                    </p>
                    <label>
                        <span class="checkboxOuter">
