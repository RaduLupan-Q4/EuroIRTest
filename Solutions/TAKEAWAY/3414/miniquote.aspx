...
<script id="IRMiniquoteModuleTemplate" type="text/x-handlebars-template">
    ...
    <div class="IRMiniQuoteQuoteModule table-look responsive">
        <div class="miniquoteDetailsWrapper">
            ...
            <div class="Data closeDate">{{showDateWithFormat timestamp 'DD MMM YYYY'}} {{showTime stocks/timestamp}} {{showLocalTimeZoneShort}}</div>
        </div> 
    </div>
    <a href="https://corporate.takeaway.com/investors/shareholder-information/" target='_self'><span class="arrow-image"></a></span>
