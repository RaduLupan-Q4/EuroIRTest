...
<div class="customVol">Volume</div>
...
<script id="IRQuoteTableTemplate" type="text/x-handlebars-template">
    ...
    <div class="updated"><span>{{headers/t_updated}}: </span><span>{{showDateWithFormat stocks/timestamp 'DD MMM YYYY HH:MM'}}</span></div>
</script>
...
<!--<script type="text/javascript" src="inc/scripts/core/ir.util.draw.js?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("inc/scripts/core/ir.util.draw.js")).Ticks.ToString()%>"></script>-->
