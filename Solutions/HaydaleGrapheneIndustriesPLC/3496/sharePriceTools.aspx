...
<% 
    ...
    site.appendCustomCSSURL = "//www.investorcom.co.uk/SharePriceChart/Haydale.css";
...
<link rel="stylesheet" type="text/css" media="screen" href="ir.client.css?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("ir.client.css")).Ticks.ToString()%>"/>
<link rel="stylesheet" type="text/css" media="screen" href="investorcom.css?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("investorcom.css")).Ticks.ToString()%>"/>
