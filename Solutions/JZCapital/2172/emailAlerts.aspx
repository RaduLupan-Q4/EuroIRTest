...
<% 
                // Settings
                string activeClient = "JZ Capital";
                int solutionID = 2172;
                int instrumentID = 1589568;
...
<head>
    ...
    <link rel="stylesheet" href="ir.client.css?v=<%=System.IO.File.GetLastWriteTime(System.Web.HttpContext.Current.Server.MapPath("client.css")).Ticks.ToString()%>" />
...
<script type="text/javascript">
    ...
    $('#loginscreen_loginButton').click(function () {
        ...
        $.ajax({
            url: '../../../Tools/EmailAlertsWithPush/EmailAlertsManager.aspx?action=getuserinformation&solutionID=2172&ts=' + (new Date).getTime(),
