    ...
    <script id="IRLookupTableTemplate" type="text/x-handlebars-template">
        <table class="IRLookupResultsTable table-look table-look2 horizontal responsive">
            <tr>
                ...
                <th class="Header last">{{headers/t_share_price}}</th>
            ...
            <tr>
                ...
                <td class="Data last">{{decimal closePrice 2}}</td>
                <td class="Data change {{formatColour low}}">{{decimal low 2}}</td>
                <td class="Data column-last changePercentage {{formatColour closePrice}}">{{decimal closePrice 2}}</td>
