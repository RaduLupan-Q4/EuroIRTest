...
<script id="IRMiniquoteChartModuleTemplate" type="text/x-handlebars-template">
        ...
        <div class="stockQuote table-wrapper">
            ...
            <button type="submit" class="submit">Stock Chart</button>
        </div>
    </script>
...
<script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            if (style == 'light') {
                ...
                $('head').append('<link rel="stylesheet" type="text/css" href="stockQuote_light.css">');
            } else {
                $('head').append('<link rel="stylesheet" type="text/css" href="stockQuote_dark.css">');
            }
