...
<%= site.newHeader("IRLookup") %>
 ...
 <script type="text/javascript">
    ...
    <script id="IRLookupTemplate" type="text/x-handlebars-template">
		...
		<form id="lookup-table-form" style="display: none;">
			<div>
				<label>From</label>
		...
		<iframe src="about:blank" class="lookup-table table-only" id="lookupIframe"></iframe>
    </script>
    ...
    <script id="IRLookupTableTemplate" type="text/x-handlebars-template">
        <table class="IRLookupResultsTable table-look horizontal responsive">
            <tr>
                ...
                <th class="Header open">{{headers/t_last}}</th>
...
<%= site.newFooter("IRLookup") %>
 ...
 <script type="text/javascript">
		function updateTimeframe(){
            var graphUrlTemplate = "lookup2.aspx?mode=list&from=__FROM__&to=__TO__&frequency=Daily&listing=0";
