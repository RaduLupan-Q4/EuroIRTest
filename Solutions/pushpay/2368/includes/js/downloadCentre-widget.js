...
if (language == undefined || language == 'en') {
    ...
    //only get 3 row
    var amountOfRows = 3;
    $.getJSON('https://ir.euroinvestor.com/ServiceEngine/api/json/reply/RequestAnnouncementType?apiversion=1&lcid=1033&customerKey=pushpay&solutionID=2368&MaxRows=' + amountOfRows + '&pageno=0&instrumentid='+IRInstrumentID+'&SourceId=1017', function (data) {
        var allData = data;
