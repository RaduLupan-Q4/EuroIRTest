...
Handlebars.registerHelper('newsarticle', function (objects, options) {
    ...
    return 'https://ir.euroinvestor.com/Tools/newsArticleHTML.aspx?solutionID=1804&customerKey=AlmBrand&storyID=' + objectValue;
});
Handlebars.registerHelper('irfile', function (objects, options) {
    ...
    return 'https://irssl.euroinvestor.com/IR/Files/ClientAdmin/DownloadCenter/' + objectValue;
});
...
if (language != undefined && language == 'en') {
    $.getJSON('https://ir.euroinvestor.com/serviceengine/api/json/reply/RequestAnnouncement?lcid=2057&apiVersion=1&solutionID=1804&CustomerKey=AlmBrand&InstrumentID=100059 ', function (data) {
    //$.getJSON('https://devir.euroinvestor.com/ServiceEngine/api/json/reply/RequestNews?lcid=2057&pageNo=0&maxRows=20000&headlinesOnly=true&instrumentID=1000402&apiVersion=1&solutionID=2290&customerKey=GoAhead ', function (data) {
        var allData = data;
        console(allData);
    ...
    $.getJSON('https://ir.euroinvestor.com/serviceengine/api/json/reply/RequestAnnouncement?lcid=1030&apiVersion=1&solutionID=1804&CustomerKey=AlmBrand&InstrumentID=100059 ', function (data) {
        var allData = data;
