...
<div class="wrapper1">
    <div class="announcementsHeader">
        <span>Key dates for investors</span>
            ...
            <div class="CalendarDate category_{{getCategory keyValueSet 'calendartype'}}">
                ...
                <div class="contentWrapper">
                    <div class="headlineWrapper">
                        ...
                        <div class="CalendarContentWrapper">
                            <div class="calendarContent">
                                ...
                                <span class="calendarTime"><b>{{showDateWithFormat startTime 'h:mma'}}</b> - <span class="descriptionText">{{text}}</span></span>
                            </div>
                        </div>
                    </div>
                    <div class="calendarMoreInfo">
                        ...
                        <!-- <form method="post" action="https://devir.euroinvestor.com/tools/generateICS/default.aspx" > -->
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $.getJSON(getServiceEngingeURL() + 'RequestNewsCalendarPagination?apiversion=1&lcid=1033&customerKey=pushpay&solutionID=2368&MaxRows=100&pageno=0&instrumentid=' + IRInstrumentID + '&StartDate=' + convertedDate + '', function (data) {
    ...
    function selectPeriod() {
        ...
        $.getJSON(getServiceEngingeURL() + 'RequestNewsCalendarPagination?apiversion=1&lcid=1033&customerKey=pushpay&solutionID=2368&MaxRows=20000&pageno=0&instrumentid=' + IRInstrumentID + '&StartDate=' + periodStartDate + '', function (data) {
        ...
        if (!customXApplied) {
            ...
            $("#emailCalendarSignup_submit").click(function () {
                ...
                var checkedValues = $('.calendarReminder_checked').map(function () {
                    ...
                    var eventDate = new moment(eventStartTime, 'YYYY-MM-DD HH:mm');
                    //var eventDate = new Date(eventStartTime, "YYYY-MM-DD HH:mm");
                ...
                if (isValidEmailAddress($('#emailCalendarSignup').val()) && checkedValues.length != 0) {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "https://ir.euroinvestor.com/tools/CalendarEvents/default.aspx",
            ...
            $(".calendarDetails").click(function () {
                ...
                if ($(this).hasClass('calendarDetails_expanded')) {
                    ...
                    $(this).closest('.IRDataGroup').find('.calendarTime').removeAttr("style");

                } else {
                    $(this).addClass('calendarDetails_expanded');
                    $(this).closest('.IRDataGroup').find('.calendarTime').css('height', 'auto');
                    //$(this).find(".calendarTime").addClass("test");
                    //$(this).parent().find(".calendarTime").css('height', 'auto');
                    //$('.calendarTime').css('height', 'auto');
                }
