            ...
            <div class="filter-wrapper">
                ...
                <div class="datepicker">
                    <div class="search-from">
                        ...
                        <%--<div class="records">
                            <span class="textArea">{{headers/t_records_per_page}}:</span>
                            <select id="select-filter">
        ...
        <div>
            ...
            <div class="IRNewsTool table-look horizontal responsive">
                ...
                <div class="IRDataGroup" id="{{storyID}}">
                    ...
                    <div class="IRData IRDate column-first" id="{{showDateWithFormat timestamp 'YYYY-MMM-DD'}}">{{showDateWithFormat timestamp 'DD MMM YYYY'}}</div>

                    <div class="IRData IRDownload">
                        <div class="IRDownloadKB">
                            <span>{{showFileSize pdfFileSize}} </span>
                        </div>
