...
<head>
    ...
    <link rel="stylesheet" href="emailAlerts.css?v=145087256228" />
            ...
            <div class="blockOuter">
                ...
                <form action="emailAlerts.aspx">
                    ...
                    <div class="blockOuter">
                        ...
                        <h2 class="header">If you are already subscribed to this service, please <a class="cleanLink OLDformUnsubscribe OLDunsubscribeNextToButton loginButton">Login</a>
                        </h2>
                        <p>
                        ...
                        <div class="subGroup">
                            ...
                            <form action="">
                                <input type="radio" name="release" value="no"> No<br>
                                <input type="radio" id="ReleaseRSSTrigger" class="ReleaseRSS" name="release" value="yes"> Yes
                            </form>
...
<%--                            <div id="ReleaseRSSTrigger" class="checkbox ReleaseRSS">Press Releases</div>
        ...
        <div id="loginscreen" style="text-align:center;float:none;border:1px solid #cccccc;background-color:#f4f4f4;padding:20px;display:none;">
            <div style="width:280px;margin:auto">
                ...
                <input  type="text" name="loginEmail" placeholder="" />
        ...
        <div id="invalidemailscreen" style="text-align:center;float:none;border:1px solid #cccccc;background-color:#f4f4f4;padding:20px;display:none;">
            <div style="width:280px;margin:auto">
                <div style="border:0px solid black;color:red"><div>The email address is invalied, please try again</div></div>
                <div style="margin-top:30px;border:0px solid black;">
    ...
    <script type="text/javascript">
            ...
            $('#loginscreen_loginButton').click(function () {
                $.ajax({
                    ...
                    success: function (userData) {
                        ...
                        $('#enterInformationCountry').val(userData.optional_language);
        ...
        function checkInputFields() {
            ...
            if (!isOK) {
                $('.requiredSymbol').css('display', 'block');
