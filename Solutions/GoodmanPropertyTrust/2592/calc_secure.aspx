...
<script id="IRCalcTemplate" type="text/x-handlebars-template">
    ...
    <div id="container" class="tabs">
        <ul class="tabsWrapper">
            ...
            <li class="tabitem tab-3"><a class="current" href="//ir.euroinvestor.com/Solutions/GoodmanPropertyTrust/2592/calc_secure.aspx" target="_self">Investment calculator</a></li>
        </ul>
    </div>
</div>
