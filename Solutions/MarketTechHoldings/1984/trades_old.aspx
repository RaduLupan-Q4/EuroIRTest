    ...
    <table class="IRTradesModule table-look horizontal responsive" id="scroll-table">
        ...
        <tbody style="width: 100%;">
            ...
            <tr>
                ...
                <td class="Data changePercent">{{showTradeChangePercentage tradePrice}}</td>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        setTimeout(function () {
            ...
            $("#scroll-table tr").each(function () {
                var curr = Number($(this).find("td.changePercent").html());
                var prev = Number($(this).next().find("td.changePercent").html());

                var thisHTML = '';
                thisHTML = $(this).find("td.changePercent").html();
                if (curr > prev) {
                    $(this).find("td.changePercent").addClass('formatColourPos');
                }
                    ...
                    $(this).find("td.changePercent").addClass('formatColourNeg');
                }

                $(this).find("td.changePercent").html(thisHTML);


            });
            //Compare Change
            $("#scroll-table tr").each(function () {
                var curr = Number($(this).find("td.change").html());
                var prev = Number($(this).next().find("td.change").html());
