...
<script id="IRLookupTemplate" type="text/x-handlebars-template">
    ...
    <div class="IRChartLookupPlaceholder">
    ...
    <table class="IRLookupResultsTable table-look horizontal responsive">
        ...
        {{#each closePrices}}
            <tr>
                ...
                <td class="Data price">{{thousands openPrice 2}}</td>
                <td class="Data high">{{thousands high 2}}</td>
                <td class="Data low">{{thousands low 2}}</td>
                <td class="Data">{{thousands closePrice 2}}</td>
